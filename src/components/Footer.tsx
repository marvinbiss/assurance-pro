...
const FOOTER_GROUPS = [
  {
    ...
    links: [
      ...
      { label: 'Prévoyance TNS', href: '/prevoyance-tns' },
      { label: 'Dommages-ouvrage', href: '/assurance-dommages-ouvrage' },
      { label: 'Tous Risques Chantier', href: '/assurance-tous-risques-chantier' },
      { label: 'Homme-clé', href: '/assurance-homme-cle' },
      { label: 'Flotte automobile', href: '/assurance-flotte-automobile' },
      { label: 'Moto pro', href: '/assurance-moto-professionnelle' },
      { label: 'Transport marchandises', href: '/assurance-transport-marchandises' },
      { label: 'Protection juridique', href: '/protection-juridique-professionnelle' },
    ],
  },
  {
    title: 'Cabinet',
  ...
  },
  {
    ...
    links: [
      { label: 'Calculateur décennale', href: '/outils/calculateur-tarif-decennale' },
      { label: 'Calculateur RC Pro', href: '/outils/calculateur-tarif-rc-pro' },
      { label: 'Calculateur multirisque', href: '/outils/calculateur-tarif-multirisque-pro' },
      { label: 'Calculateur cyber', href: '/outils/calculateur-tarif-cyber-assurance' },
      { label: 'Calculateur VTC', href: '/outils/calculateur-tarif-vtc' },
      { label: 'Calculateur mutuelle TNS', href: '/outils/calculateur-tarif-mutuelle-pro' },
      { label: 'Modèle attestation décennale', href: '/outils/modele-attestation-decennale' },
      { label: 'Modèle attestation RC Pro', href: '/outils/modele-attestation-rc-pro' },
      { label: 'Modèle devis pro', href: '/outils/modele-devis-pro' },
      { label: 'Modèle facture pro', href: '/outils/modele-facture-pro' },
      { label: 'Lettre résiliation', href: '/outils/lettre-resiliation-assurance' },
    ],
  },
  {
    title: 'Ressources',
