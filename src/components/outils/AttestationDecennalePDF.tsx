...
export function AttestationDecennalePDF({ data }: { data: AttestationData }) {
  ...
  return (
    <Document title="Modèle attestation décennale — Assurance Pro" author="Assurance Pro (modèle type)">
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Modèle conforme à l&apos;arrêté du 23 janvier 2024 — Loi Spinetta art. L. 241-1 C. assur.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>Loi Spinetta du 4 janvier 1978 (art. L. 241-1 C. assur.)</Text>
          </View>
        </View>
        ...
        <View style={styles.legalRef}>
          ...
          <Text>
            ...
            valable juridiquement. Seule une attestation émise et signée par votre assureur
            réel a une valeur opposable aux tiers (clients, maîtres d&apos;ouvrage,
            administration). Pour obtenir une attestation conforme et opposable :
            souscrivez une décennale chez un courtier ORIAS sous 24h sur https://assurance-pro.fr/devis
          </Text>
        </View>

        <View style={styles.footer} fixed>
          <Text>Modèle généré par Assurance Pro (https://assurance-pro.fr) — {dateEmission}</Text>
          <Text>Conformité arrêté 23 janvier 2024 (mentions obligatoires) — Loi Spinetta art. L. 241-1 C. assur.</Text>
        </View>
      </Page>
    </Document>
  )
