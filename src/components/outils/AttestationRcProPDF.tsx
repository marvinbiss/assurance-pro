      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Modèle conforme à l&apos;arrêté du 23 janvier 2024 — Article L. 113-1 du Code des
            assurances
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>Plafond par sinistre :</Text>
            <Text style={styles.value}>{data.plafondParSinistre}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Plafond annuel cumulé :</Text>
            <Text style={styles.value}>{data.plafondAnnuel}</Text>
          </View>
        </View>
