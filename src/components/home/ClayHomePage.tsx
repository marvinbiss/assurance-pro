...
const FALLBACK_REVIEWS = [
  { client_name: 'Marie Fontaine', rating: 5, comment: "Marc a réglé ma fuite d'eau en urgence un dimanche soir. Rapide, propre, prix honnête. Assurance Pro m'a littéralement sauvé la mise.", created_at: '', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face&q=80' },
        ...
        <div className="relative overflow-hidden flex items-center" style={{ minHeight: '360px' }}>
          ...
          <div className="relative z-10 max-w-[1320px] mx-auto px-5 md:px-10 py-20 text-center w-full">
            ...
            <p className="text-base leading-[1.7] mb-8 max-w-xl mx-auto text-white/80">
              Des milliers de propriétaires font confiance à Assurance Pro pour leurs travaux.
            </p>
