...
export function PlatformPhoneLabel({
  ...
  const tooltipText = 'Ce numéro est celui de Assurance Pro, pas celui de l\'artisan. Nous vous mettons en relation avec le bon professionnel.'
