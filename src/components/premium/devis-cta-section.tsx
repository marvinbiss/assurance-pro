...
export function DevisCTASection({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -left-32 top-0 h-[400px] w-[400px] rounded-full bg-primary-600/30 blur-[120px]" />
      <div className="pointer-events-none absolute -right-32 bottom-0 h-[360px] w-[360px] rounded-full bg-secondary-500/20 blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            ...
            className="group inline-flex items-center gap-2 rounded-xl bg-primary-500 px-8 py-4 text-base font-semibold text-white shadow-premium-terra transition-all duration-200 ease-enter hover:-translate-y-0.5 hover:bg-primary-600"
          >
            {primaryCta.label}
            <ArrowRight
