...
const DEFAULT_FROM = 'Assurance Pro <noreply@assurance-pro.fr>'
...
export const emailTemplates = {
  ...
  welcome: (name: string): EmailTemplate => ({
    subject: 'Bienvenue sur Assurance Pro !',
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Nous sommes ravis de vous accueillir sur Assurance Pro.</p>
            ...
            <div class="footer">
              <p>Assurance Pro - Trouvez des artisans qualifiés près de chez vous</p>
            </div>
          </div>
        </body>
      </html>
  ...
  welcomeArtisan: (name: string): EmailTemplate => ({
    subject: 'Bienvenue sur Assurance Pro - Votre espace artisan est prêt !',
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Félicitations ! Vous faites maintenant partie de la communauté Assurance Pro.</p>
