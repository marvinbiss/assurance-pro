export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || 'https://assurance-pro.fr').trim().replace(/\/+$/, '')
...
export const defaultSEOConfig = {
  titleTemplate: '%s | Assurance Pro',
  defaultTitle: 'Assurance Pro — Comparez et économisez en 2 minutes',
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Assurance Pro — Courtier ORIAS multi-vertical',
      },
    ],
  },
  twitter: {
