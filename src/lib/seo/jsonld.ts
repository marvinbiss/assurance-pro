...
// Schema.org InsuranceAgency (E-E-A-T critique pour YMYL)
export function getOrganizationSchema() {
  ...
  return {
    ...
    identifier: [
      { '@type': 'PropertyValue', propertyID: 'ORIAS', value: ORIAS },
    ],
    knowsAbout: [
    ...
    description: 'Courtier ORIAS spécialiste assurance professionnelle. Décennale, RC Pro, Multirisque, Mutuelle TNS, VTC, Cyber.',
