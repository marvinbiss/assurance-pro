...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #1a1a1a;">
  ...
  <p style="color: #555; line-height: 1.6;">
    Des centaines de propriétaires trouvent chaque mois leur artisan de confiance sur Assurance Pro.
  ...
  <div style="text-align: center; margin: 32px 0;">
    <a href="https://www.assurance-pro.fr/devis"
  ...
  <p style="color: #999; font-size: 12px; text-align: center; margin-top: 40px;">
    Vous recevez cet email car vous avez commencé une demande de devis sur Assurance Pro.<br>
