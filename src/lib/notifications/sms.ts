/**
 * SMS Notification System - Assurance Pro
...
${data.artisanName}
Gérer: assurance-pro.fr/b/${data.bookingId.slice(0, 8)}`,
...
${data.date} à ${data.time}
${data.artisanName}
Confirmer/Annuler: assurance-pro.fr/b/${data.bookingId.slice(0, 8)}`,
