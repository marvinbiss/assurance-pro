...
export const RC_PRO_PROFESSIONS: Record<string, ProfessionRcPro> = {
  ...
  'freelance-it': {
    ...
    tagline: 'RC Pro freelance IT — Développement, intégration, déploiement. Couverture cyber incluse.',
    intro: 'Le freelance IT (développeur, DevOps, consultant cloud) intervient sur des projets critiques pour ses clients. Un bug, une faille de sécurité, un déploiement raté peut générer une perte d\'exploitation, une fuite de données ou une mise en cause RGPD. Les ESN et grands comptes exigent quasi-systématiquement une RC Pro avec extension cyber. Notre cabinet négocie des plafonds 1-3M€ adaptés aux freelances IT à partir de 200€/an.',
    obligatoire: false,
    tarifs: {
  ...
  designer: {
    ...
    aliases: ['Designer graphique', 'UX/UI Designer', 'Illustrateur'],
    nafCodes: ['7410Z'],
    tagline: 'RC Pro designer — Couvrez vos créations graphiques, UX/UI et droits d\'auteur.',
    intro: 'Le designer graphique ou UX/UI fait face à des risques liés au droit d\'auteur (utilisation d\'éléments protégés), au délai de livraison et à la conformité du livrable (charte graphique, brand guidelines). La RC Pro designer protège contre les litiges client et les mises en cause pour contrefaçon involontaire. Tarifs accessibles à partir de 130€/an pour un auto-entrepreneur.',
    obligatoire: false,
    tarifs: {
  ...
  photographe: {
    ...
    intro: 'Le photographe professionnel (mariage, événementiel, corporate, portrait) fait face à des risques spécifiques : dommages matériel (vol, casse), perte de fichiers (carte SD défectueuse), dommages corporels lors de séances, droit à l\'image. Notre cabinet propose des contrats sur-mesure avec garantie matériel à partir de 500€/an.',
    obligatoire: false,
    tarifs: {
      auto_entrepreneur: { min: 200, max: 400 },
  ...
  'coach-pro': {
    ...
    intro: 'Le coach professionnel (business, vie, sportif si certifié) intervient en accompagnement individuel ou collectif. Les risques : mise en cause sur la qualité de l\'accompagnement, conflit avec un client, atteinte à la réputation. La RC Pro coach est généralement à 200-400€/an, idéale pour les auto-entrepreneurs.',
    obligatoire: false,
    tarifs: {
  ...
  'auto-entrepreneur': {
    ...
    nafCodes: ['*'],
    tagline: 'RC Pro auto-entrepreneur — La couverture pro adaptée à votre statut. À partir de 9€/mois.',
    intro: 'Le statut d\'auto-entrepreneur n\'exonère pas de la responsabilité civile professionnelle : un auto-entrepreneur engage son patrimoine personnel en cas de sinistre. La RC Pro auto-entrepreneur permet de protéger ses biens personnels (résidence, comptes bancaires) en cas de mise en cause. Tarifs ultra-accessibles à partir de 9€/mois selon l\'activité. Notre cabinet ORIAS travaille avec Hiscox, April Pro, Stello et Wakam, spécialisés AE.',
    obligatoire: false,
    referenceLegale: 'Selon activité (obligatoire pour BTP, médical, juridique, immobilier, agences voyages)',
    tarifs: {
  ...
  formateur: {
    ...
    intro: 'Le formateur indépendant ou organisme de formation (Qualiopi obligatoire pour CPF/OPCO) doit couvrir sa responsabilité pédagogique : non-conformité du contenu de formation, absence de résultats, accident lors d\'une session, mise en cause sur la certification. Notre cabinet propose des contrats RC Pro formateur à partir de 280€/an avec extension Qualiopi.',
    obligatoire: false,
    tarifs: {
      auto_entrepreneur: { min: 200, max: 400 },
  ...
  avocat: {
    ...
    intro: 'La RC Pro est OBLIGATOIRE pour les avocats (art. 27 Loi 71-1130 + Décret 96-1080). Elle couvre les fautes professionnelles, le devoir de conseil, la confidentialité.',
    obligatoire: true,
    referenceLegale: 'Art. 27 Loi 71-1130 + Décret 96-1080',
    tarifs: { auto_entrepreneur: { min: 850, max: 1800 }, sarl_sas: { min: 2200, max: 5500 }, grand_compte: { min: 8000, max: 22000 } },
  ...
  notaire: {
    ...
    intro: 'La RC Pro notaire est obligatoire (art. 13 Décret 73-541). Couvre les actes authentiques, le conseil, la responsabilité solidaire.',
    obligatoire: true,
    referenceLegale: 'Art. 13 Décret 73-541',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 5500, max: 12000 }, grand_compte: { min: 18000, max: 50000 } },
    plafondRecommande: 5,
  ...
  'expert-comptable': {
    ...
    intro: 'La RC Pro est obligatoire pour les experts-comptables (Code de déontologie OECCA). Couvre les missions de comptabilité, audit, conseil fiscal et social.',
    obligatoire: true,
    referenceLegale: 'Code déontologie OECCA',
    tarifs: { auto_entrepreneur: { min: 320, max: 750 }, sarl_sas: { min: 1500, max: 4500 }, grand_compte: { min: 6500, max: 18000 } },
    plafondRecommande: 2,
    risques: ['Erreur déclaration fiscale', 'Mauvais conseil fiscal', 'Fraude collaborateur', 'Cyber'],
  ...
  'commissaire-aux-comptes': {
    ...
    intro: 'La RC Pro est obligatoire pour les CAC (art. L. 822-17 C. com.). Couvre les missions d\'audit légal et contrôle des comptes.',
    obligatoire: true,
    referenceLegale: 'Art. L. 822-17 C. com.',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 3500, max: 9500 }, grand_compte: { min: 12000, max: 35000 } },
    plafondRecommande: 5,
  ...
  huissier: {
    ...
    intro: 'La RC Pro est obligatoire pour les commissaires de justice (ord. 2016-728). Couvre actes d\'huissier, recouvrement, constats.',
    obligatoire: true,
    referenceLegale: 'Ord. 2016-728',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 1800, max: 4500 }, grand_compte: { min: 6000, max: 16000 } },
    plafondRecommande: 1.5,
  ...
  'mandataire-judiciaire': {
    ...
    intro: 'RC Pro obligatoire (art. L. 814-9 C. com.). Couvre les procédures collectives, mandataires, administrateurs judiciaires.',
    obligatoire: true,
    referenceLegale: 'Art. L. 814-9 C. com.',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 4500, max: 11000 }, grand_compte: { min: 14000, max: 38000 } },
    plafondRecommande: 3,
  ...
  'medecin-generaliste': {
    ...
    intro: 'RC Pro médicale obligatoire (art. L. 1142-2 CSP — Loi Kouchner 2002). Plafond minimum légal 8M€/sinistre. Risque sinistralité élevé.',
    obligatoire: true,
    referenceLegale: 'Art. L. 1142-2 CSP — Loi Kouchner',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 850, max: 1800 }, grand_compte: { min: 2200, max: 5500 } },
    plafondRecommande: 8,
  ...
  'medecin-specialiste': {
    ...
    intro: 'RC Pro médicale obligatoire avec sinistralité variable selon spécialité (chirurgie >> autres). Plafond légal 8M€/sinistre minimum.',
    obligatoire: true,
    referenceLegale: 'Art. L. 1142-2 CSP',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 1800, max: 5500 }, grand_compte: { min: 6500, max: 25000 } },
    plafondRecommande: 8,
  ...
  chirurgien: {
    ...
    intro: 'Spécialité à très forte sinistralité (sinistres rares mais coûts moyens > 500k€). RC Pro obligatoire avec plafonds renforcés conseillés.',
    obligatoire: true,
    referenceLegale: 'Art. L. 1142-2 CSP',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 8500, max: 25000 }, grand_compte: { min: 25000, max: 80000 } },
  ...
  'infirmiere-liberale': {
    ...
    intro: 'RC Pro obligatoire pour les IDEL (art. L. 4312-7 CSP). Couvre soins à domicile, gestes techniques.',
    obligatoire: true,
    referenceLegale: 'Art. L. 4312-7 CSP',
    tarifs: { auto_entrepreneur: { min: 180, max: 380 }, sarl_sas: { min: 380, max: 850 }, grand_compte: { min: 1200, max: 2800 } },
    plafondRecommande: 8,
  ...
  kinesitherapeute: {
    ...
    intro: 'RC Pro obligatoire pour les masseurs-kinésithérapeutes. Couvre gestes thérapeutiques, conseils, équipements.',
    obligatoire: true,
    referenceLegale: 'Art. L. 4321-19 CSP',
    tarifs: { auto_entrepreneur: { min: 180, max: 380 }, sarl_sas: { min: 380, max: 950 }, grand_compte: { min: 1500, max: 3500 } },
    plafondRecommande: 8,
  ...
  osteopathe: {
    ...
    intro: 'RC Pro fortement recommandée pour ostéopathes (encadrement légal Décret 2007-435). Couvre manipulations, conseils.',
    obligatoire: false,
    referenceLegale: 'Décret 2007-435',
    tarifs: { auto_entrepreneur: { min: 220, max: 480 }, sarl_sas: { min: 480, max: 1100 }, grand_compte: { min: 1500, max: 3500 } },
    plafondRecommande: 6,
  ...
  'sage-femme': {
    ...
    intro: 'RC Pro médicale obligatoire (art. L. 1142-2 CSP). Couvre suivi grossesse, accouchement, postnatal.',
    obligatoire: true,
    referenceLegale: 'Art. L. 1142-2 CSP',
    tarifs: { auto_entrepreneur: { min: 380, max: 850 }, sarl_sas: { min: 850, max: 2200 }, grand_compte: { min: 2800, max: 6500 } },
    plafondRecommande: 8,
  ...
  dentiste: {
    ...
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 1500, max: 3800 }, grand_compte: { min: 4500, max: 12000 } },
    plafondRecommande: 8,
  ...
  psychologue: {
    ...
    intro: 'RC Pro non légalement obligatoire mais fortement recommandée. Couvre les manquements au devoir de conseil et confidentialité.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 320 }, sarl_sas: { min: 320, max: 850 }, grand_compte: { min: 1100, max: 2500 } },
    plafondRecommande: 2,
  ...
  pharmacien: {
    ...
    intro: 'RC Pro obligatoire (Code déontologie pharmaciens). Couvre dispensation, conseil, préparations magistrales.',
    obligatoire: true,
    referenceLegale: 'Code déontologie pharmaciens',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 2200, max: 5500 }, grand_compte: { min: 6500, max: 18000 } },
    plafondRecommande: 5,
  ...
  veterinaire: {
    ...
    intro: 'RC Pro obligatoire (Code déontologie vétérinaires). Couvre soins, chirurgie, prescription.',
    obligatoire: true,
    referenceLegale: 'Code déontologie vétérinaires',
    tarifs: { auto_entrepreneur: { min: 220, max: 480 }, sarl_sas: { min: 950, max: 2500 }, grand_compte: { min: 3500, max: 9500 } },
    plafondRecommande: 2,
  ...
  architecte: {
    ...
    intro: 'RC Pro et décennale obligatoires (Loi 77-2 + Loi Spinetta). Sinistralité élevée sur conception.',
    obligatoire: true,
    referenceLegale: 'Loi 77-2 + Loi Spinetta',
    tarifs: { auto_entrepreneur: { min: 850, max: 2200 }, sarl_sas: { min: 2200, max: 6500 }, grand_compte: { min: 8500, max: 25000 } },
    plafondRecommande: 1.5,
    risques: ['Erreur conception', 'Manquement permis', 'Décennale ouvrage', 'Coordination chantier'],
  ...
  'agent-immobilier': {
    ...
    intro: 'RC Pro obligatoire (Loi Hoguet + Décret 72-678). Couvre transactions immobilières, gestion locative.',
    obligatoire: true,
    referenceLegale: 'Loi Hoguet + Décret 72-678',
    tarifs: { auto_entrepreneur: { min: 380, max: 850 }, sarl_sas: { min: 850, max: 2500 }, grand_compte: { min: 3500, max: 9500 } },
    plafondRecommande: 0.5,
    risques: ['Erreur diagnostic obligatoire', 'Manquement information acquéreur', 'Garantie financière'],
  ...
  'syndic-immobilier': {
    ...
    tarifs: { auto_entrepreneur: { min: 580, max: 1300 }, sarl_sas: { min: 1300, max: 3500 }, grand_compte: { min: 4500, max: 12000 } },
    plafondRecommande: 1.5,
  ...
  'diagnostic-immobilier': {
    ...
    intro: 'RC Pro obligatoire pour les certifications (DPE, amiante, plomb, termites). Forte sinistralité DPE post-réforme 2021.',
    obligatoire: true,
    referenceLegale: 'Art. L. 271-6 CCH',
    tarifs: { auto_entrepreneur: { min: 380, max: 850 }, sarl_sas: { min: 850, max: 2200 }, grand_compte: { min: 2800, max: 7500 } },
    plafondRecommande: 0.5,
    risques: ['Erreur DPE', 'Amiante non détectée', 'Termites non identifiés'],
    garantiesRecommandees: ['RC Pro 500k€', 'Garantie subséquente 10 ans', 'Multirisque équipement'],
    icon: '🔍',
    nbProsFrance: 12000,
  },
  geometre: {
    ...
    intro: 'RC Pro obligatoire (Loi 46-942). Couvre bornage, division parcellaire, plans topographiques.',
    obligatoire: true,
  ...
  'developpeur-freelance': {
    ...
    intro: 'Le métier de dev freelance expose à la mise en cause sur livrables, retards, bugs. Demandée par 80% des clients ESN.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 380, max: 1100 }, grand_compte: { min: 2200, max: 5500 } },
    plafondRecommande: 1,
    risques: ['Bug en production', 'Retard livraison', 'Fuite code source', 'Propriété intellectuelle'],
  ...
  'data-scientist': {
    ...
    intro: 'Profession à risques RGPD et IA Act renforcés. Mise en cause possible sur biais ML, fuite données, modèles défaillants.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 380 }, sarl_sas: { min: 580, max: 1500 }, grand_compte: { min: 2800, max: 7500 } },
    plafondRecommande: 1.5,
  ...
  'community-manager': {
    ...
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 280, max: 750 }, grand_compte: { min: 1100, max: 2800 } },
    plafondRecommande: 0.5,
  ...
  'consultant-seo': {
    ...
    intro: 'Risques liés aux engagements de résultats, sanctions Google (manual action), pratiques black hat.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 380, max: 1100 }, grand_compte: { min: 1800, max: 4500 } },
    plafondRecommande: 1,
  ...
  videaste: {
    ...
    intro: 'Couvre matériel pro (caméras, drones, éclairage), droit à l\'image, livraison contractuelle.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 380 }, sarl_sas: { min: 580, max: 1500 }, grand_compte: { min: 2200, max: 5500 } },
    plafondRecommande: 0.5,
  ...
  webmaster: {
    ...
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 320, max: 850 }, grand_compte: { min: 1100, max: 2800 } },
    plafondRecommande: 0.5,
  ...
  graphiste: {
    ...
    intro: 'Risque propriété intellectuelle (contrefaçon involontaire), droits images stock, livraison contractuelle.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 280, max: 750 }, grand_compte: { min: 1100, max: 2800 } },
    plafondRecommande: 0.5,
  ...
  'conseil-rh': {
    ...
    intro: 'Couvre recommandations RH, recrutement, paie. Risque RGPD important sur les CV et données salariés.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 320 }, sarl_sas: { min: 580, max: 1500 }, grand_compte: { min: 2200, max: 5500 } },
    plafondRecommande: 1,
  ...
  'conseil-financier': {
    ...
    name: 'Conseiller en gestion de patrimoine (CGP/CIF)',
    nafCodes: ['6622Z'],
    tagline: 'RC Pro CGP/CIF — Obligation ORIAS, plafond 1,5M€.',
    intro: 'RC Pro obligatoire pour les CIF (art. L. 541-3 CMF). Couvre recommandations financières, devoir de conseil.',
    obligatoire: true,
    referenceLegale: 'Art. L. 541-3 CMF + ORIAS',
    tarifs: { auto_entrepreneur: { min: 380, max: 850 }, sarl_sas: { min: 1500, max: 3500 }, grand_compte: { min: 4500, max: 12000 } },
    plafondRecommande: 1.5,
  ...
  'agent-general-assurance': {
    ...
    intro: 'RC Pro obligatoire (art. L. 512-6 C. assur.). Couvre distribution et conseil en assurance.',
    obligatoire: true,
    referenceLegale: 'Art. L. 512-6 C. assur.',
    tarifs: { auto_entrepreneur: { min: 0, max: 0 }, sarl_sas: { min: 1200, max: 3500 }, grand_compte: { min: 4500, max: 12000 } },
    plafondRecommande: 1.5,
  ...
  'consultant-marketing': {
    ...
    intro: 'Couvre les missions de marketing digital (SEA, SMA, content). Risque RGPD sur les données clients.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 96, max: 240 }, sarl_sas: { min: 380, max: 1100 }, grand_compte: { min: 1800, max: 4500 } },
    plafondRecommande: 1,
  ...
  'aide-domicile': {
    ...
    intro: 'Couvre les interventions chez les bénéficiaires (chute, casse mobilier, manquement soin). Risque corporel.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 320 }, sarl_sas: { min: 380, max: 950 }, grand_compte: { min: 1500, max: 3500 } },
    plafondRecommande: 1,
  ...
  esthetique: {
    ...
    intro: 'Couvre les soins esthétiques (épilation laser/IPL, soins visage, manucure). Sinistralité brûlures et allergies.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 220, max: 480 }, sarl_sas: { min: 480, max: 1300 }, grand_compte: { min: 1800, max: 4500 } },
    plafondRecommande: 1,
  ...
  coiffeur: {
    ...
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 320 }, sarl_sas: { min: 320, max: 850 }, grand_compte: { min: 1100, max: 2800 } },
    plafondRecommande: 0.5,
  ...
  taxi: {
    ...
    intro: 'Assurance véhicule taxi obligatoire (art. L. 211-1 C. assur.). Couvre transport rémunéré + RC tiers.',
    obligatoire: true,
    referenceLegale: 'Art. L. 211-1 C. assur. + autorisation taxi',
    tarifs: { auto_entrepreneur: { min: 1200, max: 2400 }, sarl_sas: { min: 2400, max: 5500 }, grand_compte: { min: 6500, max: 15000 } },
    plafondRecommande: 1,
    risques: ['Accident circulation', 'Vol', 'Agression conducteur'],
    garantiesRecommandees: ['Assurance taxi obligatoire', 'Protection juridique', 'IJ arrêt travail'],
    icon: '🚕',
    nbProsFrance: 58000,
  },
  ...
  restaurateur: {
    ...
    intro: 'Couvre les sinistres alimentaires (intoxication, allergène), incendie cuisine, glissades clientèle.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 480, max: 950 }, sarl_sas: { min: 1500, max: 3800 }, grand_compte: { min: 5500, max: 14000 } },
    plafondRecommande: 1,
    risques: ['Intoxication alimentaire', 'Incendie cuisine', 'Glissade clientèle', 'Erreur allergène'],
  ...
  commercant: {
    ...
    intro: 'Couvre les sinistres en boutique (glissade client, vol, casse). Multirisque pro indispensable.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 220, max: 480 }, sarl_sas: { min: 480, max: 1300 }, grand_compte: { min: 1800, max: 4500 } },
    plafondRecommande: 1,
  ...
  'agent-de-voyage': {
    ...
    intro: 'RC Pro obligatoire (Loi 2009-888). Couvre prestations vendues, défaillance prestataire, garantie financière.',
    obligatoire: true,
    referenceLegale: 'Loi 2009-888 + Atout France',
    tarifs: { auto_entrepreneur: { min: 580, max: 1300 }, sarl_sas: { min: 1500, max: 4500 }, grand_compte: { min: 5500, max: 14000 } },
  ...
  'coach-sportif': {
    ...
    intro: 'Couvre les blessures lors des sessions sportives. Carte professionnelle obligatoire (art. L. 212-1 C. sport).',
    obligatoire: true,
    referenceLegale: 'Art. L. 212-1 C. sport',
    tarifs: { auto_entrepreneur: { min: 144, max: 320 }, sarl_sas: { min: 380, max: 950 }, grand_compte: { min: 1500, max: 3800 } },
    plafondRecommande: 1.5,
  ...
  'moniteur-yoga': {
    ...
    intro: 'Couvre les blessures en cours de yoga / pilates. Recommandé même sans carte pro obligatoire.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 280 }, sarl_sas: { min: 320, max: 750 }, grand_compte: { min: 1100, max: 2800 } },
    plafondRecommande: 1,
  ...
  'animateur-jeunesse': {
    ...
    intro: 'Couvre la garde de mineurs (centres aérés, classes vertes). Obligation BAFA pour activités déclarées.',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 144, max: 280 }, sarl_sas: { min: 280, max: 750 }, grand_compte: { min: 1100, max: 2500 } },
    plafondRecommande: 1.5,
  ...
  'transporteur-leger': {
    ...
    tarifs: { auto_entrepreneur: { min: 1200, max: 2500 }, sarl_sas: { min: 2500, max: 5500 }, grand_compte: { min: 6500, max: 15000 } },
    plafondRecommande: 1,
    risques: ['Perte/casse marchandise', 'Accident circulation', 'Retard livraison'],
    garantiesRecommandees: ['RC contractuelle marchandise', 'Multirisque véhicule', 'Protection juridique'],
    icon: '📦',
    nbProsFrance: 65000,
  },
  ...
  'serrurier-depannage': {
    ...
    intro: 'Couvre les interventions de dépannage (effraction de porte, changement serrure). Marché à risque (litiges tarification).',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 380, max: 850 }, sarl_sas: { min: 850, max: 2200 }, grand_compte: { min: 2800, max: 6500 } },
    plafondRecommande: 0.5,
  ...
  'electricien-depannage': {
    ...
    intro: 'Couvre les interventions électriques de dépannage hors décennale (réparation circuits, prises, tableaux).',
    obligatoire: false,
    tarifs: { auto_entrepreneur: { min: 280, max: 580 }, sarl_sas: { min: 580, max: 1500 }, grand_compte: { min: 2200, max: 5500 } },
    plafondRecommande: 0.5,
