  ...
  sections: [
    {
      ...
      paragraphs: [
        'La Loi Madelin (1994) ouvre droit à la déduction fiscale du résultat professionnel pour les TNS — Entrepreneurs Individuels, gérants majoritaires SARL/EURL, auto-entrepreneurs et professions libérales. Pour un freelance à {ville} avec 70 k€ de bénéfice et TMI 30 %, l\'économie d\'impôt + URSSAF atteint 50-55 % de la cotisation.',
        'À {ville}, ~{ville-freelances} TNS sont éligibles. Notre cabinet ORIAS analyse votre profil et négocie auprès de 10 assureurs partenaires (April Pro, Generali, AXA, MMA, MAAF, Hiscox, etc.) pour obtenir le meilleur rapport garantie/prix.',
      ],
    },
    {
      h2: 'Tarifs mutuelle pro {ville}',
      paragraphs: [
        'Tarifs indicatifs mensuels pour un TNS célibataire à {ville} :',
      ],
      bullets: [
        'Formule essentielle (100 % BR) : 45 € – 75 €/mois',
        'Formule confort (150-200 % BR) : 75 € – 130 €/mois',
        'Formule premium (300 % BR + médecines douces) : 130 € – 220 €/mois',
    ...
    },
    {
      ...
      bullets: [
        'Santé : 7 % PASS + 3,75 % bénéfice imposable (max ~11 130 €/an)',
...
export const ASSURANCE_VTC_CONFIG: GarantieVilleConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Notre cabinet ORIAS recommande pour un VTC à {ville} :',
      ],
      bullets: [
...
export const CYBER_ASSURANCE_CONFIG: GarantieVilleConfig = {
  ...
  tagline:
    'Couverture cyber-risques et fuite de données RGPD pour les TPE/PME de {ville}. 1 entreprise sur 5 victime en France en 2025 (ANSSI).',
