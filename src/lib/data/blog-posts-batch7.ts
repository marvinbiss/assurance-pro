...
export const BLOG_POSTS_BATCH_7: Record<string, BlogPost> = {
  ...
  'tarif-rc-pro-2026-par-profession': {
    ...
    toc: [
      ...
      { id: 'conseil', title: '2. Conseil/expertise — 7 métiers' },
      { id: 'sante', title: '3. Santé/bien-être — 6 métiers' },
    ...
    body: [
      ...
      {
        id: 'conseil',
        h2: '2. Conseil/expertise — 7 métiers',
      ...
      {
        id: 'sante',
        h2: '3. Santé/bien-être — 6 métiers',
      ...
      },
      {
        ...
        paragraphs: [
          'Tarifs moyens 2026 RC Pro immobilier (CA 100 K€, plafond Loi Hoguet 500 K€/1 M€) :',
        ],
        list: {
          items: [
