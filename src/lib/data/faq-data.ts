export const faqCategories = [
  {
    ...
    questions: [
      {
        q: 'Qu\'est-ce que Assurance Pro ?',
        a: 'Assurance Pro est un annuaire d\'artisans de France. Les données proviennent directement des registres SIREN officiels de l\'État via l\'API Annuaire des Entreprises. Le service est 100% gratuit.',
      },
      {
        q: 'Le service est-il gratuit ?',
        a: 'Oui, Assurance Pro est entièrement gratuit, aussi bien pour les particuliers que pour les artisans. Pas d\'abonnement, pas de commission, pas de frais cachés. Vous pouvez rechercher, comparer et contacter autant d\'artisans que vous le souhaitez.',
      },
      {
        q: 'Comment fonctionne Assurance Pro ?',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Vous pouvez demander la suppression de votre compte et de vos données en nous contactant à dpo@assurance-pro.fr.',
      },
      {
