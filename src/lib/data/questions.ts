...
export const questions: Question[] = [
  ...
  },
  {
    ...
    detailedAnswer: [
      ...
      "Attention aux arnaques fréquentes dans la serrurerie d'urgence. Les devis téléphoniques bas (« ouverture 39 € ») ne sont jamais respectés. Exigez un devis écrit sur place avant intervention. Vérifiez les avis en ligne et privilégiez les serruriers recommandés par votre entourage ou votre assurance. Les annuaires comme Assurance Pro référencent des professionnels vérifiés.",
