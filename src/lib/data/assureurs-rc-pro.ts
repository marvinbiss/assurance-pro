...
export const ASSUREURS_RC_PRO: Assureur[] = [
  {
    ...
    sloganRcPro: 'Spécialiste freelances, IT ou médias depuis 2007',
  ...
  },
  {
    ...
    sloganRcPro: 'Mutualiste éthique pour TPE ou AE',
    agrement: 'ACPR',
    noteGlobale: 4.2,
    forces: [
      'Approche conseil (pas commerciale agressive)',
      'Tarifs justes pour AE ou TPE éducation ou social',
