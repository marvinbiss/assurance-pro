export const metiersArticles: Record<string, {
  ...
  "comment-choisir-menuisier-guide": {
    ...
    faq: [
      ...
      { question: "Comment vérifier la qualité du travail d'un menuisier ?", answer: "Demandez des photos de réalisations récentes, et si possible visitez un chantier terminé. Vérifiez la régularité des assemblages, la qualité des finitions, le bon fonctionnement des mécanismes (fenêtres, coulisses). Consultez les avis clients sur Assurance Pro et demandez des références de clients précédents." }
    ],
    keyTakeaways: [
  ...
  "comment-choisir-vitrier-guide": {
    ...
    updatedDate: "2026-03-01",
    faq: [
      { question: "Comment choisir un vitrier en urgence ?", answer: "Idéalement, identifiez un vitrier avant l'urgence via Assurance Pro. En cas de bris, sécurisez d'abord la zone et protégez l'ouverture. Appelez votre contact de confiance plutôt que le premier résultat Google. Exigez un devis avec le type de vitrage, les dimensions et le coefficient Ug." },
  ...
  "metier-menuisier-bois-alu-pvc": {
    ...
    content: [
      ...
      "## Sur Assurance Pro",
      "Trouvez des menuisiers vérifiés sur Assurance Pro : profils détaillés, qualifications contrôlées, avis clients authentiques. Que vous cherchiez un menuisier bois pour un escalier sur mesure ou un poseur de fenêtres RGE, la plateforme vous met en relation avec le bon professionnel. Consultez aussi notre [guide pour choisir un menuisier](/blog/comment-choisir-menuisier-guide)."
    ],
  ...
  "metier-peintre-batiment-evolution": {
    ...
    content: [
      ...
      "## Sur Assurance Pro",
      "Trouvez des peintres en bâtiment vérifiés sur Assurance Pro : qualifications contrôlées, assurances validées, avis clients authentiques. Que vous cherchiez un peintre pour un rafraîchissement ou un spécialiste en décoration murale, la plateforme vous connecte avec le bon professionnel."
    ],
