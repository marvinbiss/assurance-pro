...
// Default sender
const DEFAULT_FROM = process.env.RESEND_FROM_EMAIL || 'Assurance Pro <noreply@assurance-pro.fr>'
...
export async function sendBatchEmails(params: BatchEmailParams): Promise<EmailResult[]> {
  ...
  try {
    ...
    return (response.data?.data || []).map((result: { id: string }, index: number) => {
      const email = params.emails[index]!
      return {
        id: result.id,
        from: email.from || DEFAULT_FROM,
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="text-align: center; margin-bottom: 30px;">
    <h1 style="color: #2563eb; margin: 0;">Assurance Pro</h1>
  </div>

  <h2>Bienvenue ${name} !</h2>

  <p>Nous sommes ravis de vous accueillir sur Assurance Pro${isArtisan ? ', la plateforme qui connecte les artisans avec leurs clients' : ''}.</p>
  ...
  <p style="color: #666; font-size: 14px;">
    Si vous avez des questions, n'hesitez pas a nous contacter a support@assurance-pro.fr
  </p>

  <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">

  <p style="color: #999; font-size: 12px; text-align: center;">
    Assurance Pro - La plateforme des artisans qualifies
  </p>
</body>
</html>
  `
  ...
  return sendEmail({
    to,
    subject: `Bienvenue sur Assurance Pro${isArtisan ? ' !' : ', ' + name}`,
    html,
    tags: [
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  return sendEmail({
    to,
    subject: 'Reinitialisation de votre mot de passe - Assurance Pro',
    html,
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="text-align: center; margin-bottom: 30px;">
    <h1 style="color: #f59e0b; margin: 0;">Assurance Pro</h1>
  </div>
  ...
  <p style="color: #999; font-size: 12px; text-align: center;">
    Assurance Pro - La plateforme des artisans qualifies<br>
    <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://assurance-pro.fr'}" style="color: #999;">assurance-pro.fr</a>
  </p>
</body>
</html>
  `
  ...
  return sendEmail({
    to,
    subject: `Votre fiche "${providerName}" a ete validee - Assurance Pro`,
    html,
    tags: [
