...
export async function GET(request: NextRequest) {
  ...
  <text x="42" y="38" font-family="system-ui,-apple-system,sans-serif" font-size="10" fill="${subtextColor}">${verifiedLabel} sur Assurance Pro</text>
  ...
  ` : `
  <text x="55" y="90" font-family="system-ui,-apple-system,sans-serif" font-size="10" fill="${subtextColor}">${isActive ? 'Artisan actif sur Assurance Pro.fr' : 'Fiche sur Assurance Pro.fr'}</text>
  `}

  <!-- Brand -->
  <text x="${w - 15}" y="${h - 10}" text-anchor="end" font-family="system-ui,-apple-system,sans-serif" font-size="8" font-weight="600" fill="${brandColor}" opacity="0.6">Assurance Pro.fr</text>
</svg>`
  }
