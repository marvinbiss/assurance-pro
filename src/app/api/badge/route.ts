...
export async function GET(request: NextRequest) {
  ...
  <text x="12" y="20" font-family="system-ui, -apple-system, sans-serif" font-size="10" font-weight="700" fill="${accentColor}">Assurance Pro.fr</text>
  ...
  <text x="15" y="25" font-family="system-ui, -apple-system, sans-serif" font-size="11" font-weight="700" fill="${accentColor}">Assurance Pro.fr</text>
