  ...
  return (
    <PilierLayout
      ...
      benefits={[
        {
          icon: '🍽️',
          title: 'Multirisque cuisine',
          desc: 'Incendie friteuse, four, hotte. Bris matériel pro (frigo, lave-vaisselle, machines)',
        },
        {
          icon: '⚠️',
          title: 'RC intoxication alimentaire',
          desc: 'Couvre les dommages corporels causés à un client (intoxication, allergie, corps étranger)',
        },
        {
          icon: '💰',
        ...
        {
          icon: '🚪',
          title: 'RC client + RC produits',
          desc: "Client qui glisse, casse de portable au comptoir, ingestion d'objet étranger dans plat",
        },
      ]}
      sections={[
        {
          ...
          body: (
            <>
              ...
              <ul>
                <li>
                  <strong>1 restaurant sur 11</strong> subit un incendie majeur dans ses 5 premières
                  années (source : Fédération Française de l&apos;Assurance, secteur HCR 2024) —
                  friteuses, hottes encrassées, courts-circuits matériel pro
                </li>
                <li>
                  <strong>~3 200 cas d&apos;intoxication alimentaire</strong> recensés par an en
                  France impliquant un restaurant (source : Santé Publique France 2024) — coût moyen
                  indemnisation par victime : 1 800 €
                </li>
                <li>
                  <strong>1 cambriolage tous les 4 ans</strong> en moyenne pour un restaurant de
                  centre-ville
                </li>
                <li>
                  <strong>Casse matériel pro</strong> très fréquente (un four pro = 8 000-25 000 € à
                  remplacer)
                </li>
              </ul>
              <p>
                ...
                garanties intoxication alimentaire, panne du froid (perte de marchandises
                périssables), bris du matériel pro, RC client en salle (chute, casse).
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <p>
                Tarifs indicatifs 2026 basés sur les barèmes de nos 6 partenaires spécialisés HCR
                (Allianz Pro HCR, AXA Pro Restauration, MMA Pro, Generali HCR, Hiscox HCR, April Pro
                Restauration) :
              </p>
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border p-2">Restaurant traditionnel province</td>
                    <td className="border p-2 text-right">40 couverts</td>
                  ...
                  <tr>
                    <td className="border p-2">Restaurant gastronomique étoilé</td>
                    <td className="border p-2 text-right">30 couverts</td>
                    <td className="border p-2 text-right">2 200 € – 3 800 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Hôtel-restaurant 30 chambres</td>
                    <td className="border p-2 text-right">60 couverts</td>
            ...
            <>
              <ol>
                <li>
                  ...
                  événements climatiques) — base
                </li>
                <li>
                  <strong>Bris du matériel pro</strong> (four, friteuse, hotte, lave-vaisselle,
                  frigo, congélateur, machine à café) — un four pro = 8 000-25 000 € à remplacer
                </li>
                <li>
                  <strong>Pertes de denrées périssables</strong> (panne frigo, coupure électrique
                ...
                <li>
                  <strong>RC exploitation</strong> (client qui glisse, fournisseur blessé en
                  livraison, casse de portable de client au comptoir)
                </li>
                <li>
                  <strong>Pertes d&apos;exploitation</strong> (calibrée sur saisonnalité — un resto
                  de bord de mer perd 80% de son CA hors saison) — durée recommandée 12-24 mois
                </li>
                <li>
                  <strong>Bris de glace</strong> (vitrines, vitres terrasse, comptoir verre)
                </li>
                <li>
                  <strong>Protection juridique</strong> (litiges fournisseurs, bailleur, anciens
                  salariés, contrôle URSSAF)
                </li>
              </ol>
              ...
              <ul>
                ...
                <li>
                  Garantie « événements annulés » (mariage, séminaire annulé suite sinistre local)
                </li>
                <li>Garantie homme-clé (chef étoilé en arrêt de travail)</li>
                <li>
                  Garantie réputation (badbuzz suite signalement intoxication, gestion crise PR)
                </li>
              </ul>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <p>
                C&apos;est <strong>le risque #1</strong> en restauration en termes de coût potentiel
                par sinistre. Quelques chiffres :
              </p>
              <ul>
                <li>
                  <strong>Coût moyen par victime indemnisée</strong> : 1 800 € (frais médicaux +
                  arrêt de travail)
                </li>
                <li>
                  <strong>
                    Indemnisation moyenne par TIAC (Toxi-Infection Alimentaire Collective)
                  </strong>{' '}
                  impliquant 5+ personnes : 12 000-50 000 €
                </li>
                <li>
              ...
              <ul>
                <li>
                  Plafond d&apos;indemnisation par sinistre (recommandé : minimum 1 500 000 €)
                </li>
                <li>Plafond annuel cumulé (recommandé : minimum 3 000 000 €)</li>
                <li>
                  Couverture des sinistres « TIAC » (Toxi-Infection Alimentaire Collective &gt; 5
                  personnes) — souvent EXCLU en option à activer
                </li>
                <li>
                  Couverture des allergies alimentaires non signalées sur la carte (gluten, lactose,
                  fruits à coque)
                </li>
                <li>
                  Couverture du « rappel produits » (frais de communication, retrait des plats
                  préparés vendus à emporter)
                </li>
              </ul>
              <p>
                <strong>Bonne pratique HACCP</strong> : tenir à jour le plan de maîtrise sanitaire,
                les températures de stockage (relevés quotidiens), les bons de livraison
                fournisseurs. En cas de sinistre, c&apos;est ce qui permettra à l&apos;assureur
                d&apos;indemniser rapidement (preuve de bonne foi du restaurateur).
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <ul>
                <li>
                  <strong>Assurance multirisque local</strong> : obligation contractuelle du bail
                  commercial (100% des baux exigent cette couverture)
                </li>
                <li>
                  <strong>RC exploitation</strong> : non obligatoire stricto sensu mais EXIGÉE par
                  les fournisseurs principaux (Coca-Cola, Heineken, Métro, Promocash) avant
                  ouverture compte pro
                </li>
                <li>
                  <strong>Assurance employeur</strong> (si salariés) : Sécurité Sociale +
                  complémentaire santé collective (obligation ANI 2013 effet 2016)
                </li>
                <li>
                  <strong>Garantie financière professionnelle</strong> (cas particulier traiteurs /
                  vente à emporter en gros) — exigée par certaines plateformes B2B
                </li>
                <li>
                  <strong>Assurance véhicule pro</strong> (livraison à domicile, food truck) —
                  obligation Code de la route + RC professionnelle dédiée
                </li>
              </ul>
              <p>
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Les contrats spécialisés HCR intègrent un calcul de la marge brute mensuelle CALIBRÉ sur la saisonnalité réelle (ex: pour un resto de bord de mer, 80% du CA fait en juin-août — le calcul de la perte d'exploitation est ajusté en conséquence). Durée d'indemnisation recommandée : 12-24 mois minimum. Demander explicitement la « clause saisonnalité » à la souscription.",
        },
        {
        ...
        },
        {
          ...
          a: 'Devis personnalisé via notre formulaire : 24h ouvrées avec 3 propositions de nos 6 assureurs partenaires HCR. Souscription : 48h. Effet du contrat : possible dès le 1er du mois suivant ou immédiat (procédure express +120€) pour les ouvertures urgentes.',
        },
      ]}
    />
  )
