...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Décennale photovoltaïque RGE : OBLIGATOIRE Loi Spinetta + qualification RGE. Couverture panneaux solaires + onduleurs + étanchéité toiture. Sinistralité AQC 9,2% (incendies onduleurs). Tarifs 880-1 680€ par an AE, 9 200-16 000€ par an SARL 5 sal. Devis ORIAS sous 24h.',
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        {
          icon: '💰',
          title: '880-1 680 € par an AE',
          desc: 'AE installateur PV. SARL 5 salariés : 9 200-16 000 € par an. Majoration +30-90% vs électricien BTP',
        },
      ]}
      sections={[
        {
      ...
      faq={[
        ...
        },
        {
          ...
          a: "AE installateur PV : 880-1 680€ par an. SARL 5 salariés : 9 200-16 000€ par an. Variables : CA, antécédents, ancienneté qualification RGE, présence d'auto-consommation collective dans le portefeuille. Notre cabinet ORIAS compare 8 assureurs spécialisés (SMABTP, MAAF Pro, April Pro RGE, Allianz Pro BTP).",
        },
      ]}
    />
  )
