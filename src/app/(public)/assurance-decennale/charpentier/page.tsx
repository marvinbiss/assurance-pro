    ...
    <PilierLayout
      ...
      benefits={[
        {
          ...
          desc: 'Charpente = ouvrage structurel soumis décennale 10 ans. Sanctions : 75 000 € + 6 mois prison',
        },
        {
          icon: '🪵',
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p>Top 4 sinistres décennaux charpentier :</p>
              <ul>
                <li>
                  <strong>Malfaçons charpente traditionnelle (32%)</strong> — assemblage défaillant,
                  sous-dimensionnement
                </li>
                <li>
                  <strong>Fermettes industrielles défaillantes (28%)</strong> — défaut calcul,
                  contreventement insuffisant
                </li>
                <li>
                  <strong>Traitement xylophages (18%)</strong> — termites, capricornes, mérule non
                  détectés
                </li>
                <li>
                  <strong>MOB ossature bois (16%)</strong> — défaut isolation pare-pluie,
                  infiltrations
                </li>
              </ul>
      ...
      faq={[
        ...
        },
        {
          ...
          a: "OUI dans les zones réglementées (50% du territoire) — arrêté préfectoral termites. Vous devez fournir au maître d'ouvrage un état parasitaire termites datant de moins de 6 mois (loi 1999 + Loi ELAN 2018). Défaut traitement = sinistre couvert décennalement (vice non révélé).",
        },
      ]}
    />
  )
