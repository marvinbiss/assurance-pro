...
const TITLE = 'Décennale électricien BTP 2026 — Tarifs 490-880€ par an AE'
const TAGLINE =
...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Décennale électricien BTP 2026 : OBLIGATOIRE Loi Spinetta. Couverture incendies tableau, courts-circuits, défauts NF C 15-100, mise à la terre, domotique. Sinistralité AQC 5,8%. Tarifs 490-880€ par an AE, 5 200-11 000€ par an SARL 5 sal. Devis ORIAS sous 24h.',
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        {
          icon: '💰',
          title: '490-880 € par an AE',
          desc: 'AE électricien CA <50k€. SARL 5 sal : 5 200-11 000€ par an. Bonus fidélité -15% après 5 ans',
        },
      ]}
      sections={[
        {
      ...
      faq={[
        {
          ...
          a: "OUI absolument. Loi Spinetta + NF C 15-100. Toute installation électrique fixe (du tableau aux prises) = ouvrage soumis à décennale. Sanctions absence : 75 000 € + 6 mois prison + interdiction d'exercer + responsabilité civile ou pénale personnelle si sinistre incendie.",
        },
        {
          q: 'Domotique — Connecté : couvert ?',
          a: "Vérifier votre contrat. La domotique standard (volets connectés, éclairage smart) est couverte par défaut. Mais les installations IoT complexes (gestion énergie, batteries domestiques, V2G) nécessitent souvent une garantie spécifique 'systèmes intelligents' (option +80-200€ par an). Notre cabinet négocie cette garantie dans 100% des devis pour électriciens spécialisés domotique.",
        },
        {
          q: 'Tarif décennale électricien 2026 ?',
          a: 'AE électricien (CA <50k€) : 490-880 € par an. EI : 520-940 € par an. EURL ou SASU : 670-1 220 € par an. SARL 5 salariés : 5 200-11 000 € par an. SAS 10 salariés : 11 000-16 800 € par an. Variables : ancienneté, antécédents, présence de domotique avancée.',
        },
        {
          q: 'Photovoltaïque : décennale séparée ?',
          a: 'Si vous installez aussi du photovoltaïque, votre décennale standard électricien NE COUVRE PAS les panneaux solaires + onduleurs. Vous devez ajouter une extension RGE photovoltaïque (sur-prime +30-60% du tarif base). Voir notre guide /assurance-decennale ou photovoltaique.',
        },
      ]}
    />
  )
