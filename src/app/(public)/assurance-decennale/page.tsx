...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL ?? 'https://assurance-pro.fr'}/assurance-decennale` },
}
      ...
      sections={[
        {
          ...
          body: (
            <>
              <p>
                L\'obligation de souscription concerne tout professionnel intervenant dans la construction
                d\'un ouvrage&nbsp;: artisans, entreprises générales, sous-traitants, architectes, bureaux
                d\'études, maîtres d\'œuvre, constructeurs de maisons individuelles (CMI), promoteurs.
              </p>
              <p>
                Cela englobe&nbsp;: les <strong>52 métiers BTP</strong> du gros œuvre et second œuvre, les
                spécialistes de la couverture / étanchéité / charpente, les installateurs RGE
                (photovoltaïque, pompes à chaleur), les paysagistes lorsqu\'ils réalisent des ouvrages durs.
              </p>
              <p className="text-sm bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
                <strong>Auto-entrepreneurs&nbsp;:</strong> l\'obligation s\'applique aussi aux micro-entrepreneurs
                du BTP. Notre cabinet propose des contrats spécifiques adaptés au statut AE avec primes à
                partir de 35€/mois selon le métier et le CA déclaré.
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              ...
              <ul>
                <li>compromettent la <strong>solidité de l\'ouvrage</strong>&nbsp;: fissures structurelles,
                  affaissement de fondations, effondrement, etc.</li>
                <li>rendent l\'ouvrage <strong>impropre à sa destination</strong>&nbsp;: infiltrations de toiture,
                  défauts d\'étanchéité, dégâts des eaux encastrés, défauts d\'isolation phonique majeurs.</li>
                <li>affectent la <strong>solidité d\'un élément d\'équipement indissociable</strong> (canalisations
                  encastrées, faux-plafonds, escalier intégré).</li>
              </ul>
              <p>
                Le tiers lésé (maître d\'ouvrage, particulier, copropriété) peut activer la garantie pendant
                10 ans à compter de la réception. La présomption de responsabilité de l\'art. 1792 du Code
                civil signifie que c\'est à <strong>l\'artisan de prouver l\'absence de faute</strong>, pas l\'inverse.
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <p>
                Le tarif annuel d\'une décennale dépend de plusieurs facteurs&nbsp;: votre métier (sinistralité
                AQC), votre chiffre d\'affaires, votre statut juridique, vos antécédents de sinistres, votre
                zone géographique et votre ancienneté.
              </p>
              <table className="w-full text-sm border-collapse my-4">
                ...
                <tbody>
                  <tr><td className="border border-gray-300 p-2">Maçon</td><td className="border border-gray-300 p-2 text-right">1 200-2 200€</td><td className="border border-gray-300 p-2 text-right">2 000-3 500€</td><td className="border border-gray-300 p-2 text-right">6 000-10 000€</td></tr>
                  <tr><td className="border border-gray-300 p-2">Couvreur</td><td className="border border-gray-300 p-2 text-right">1 500-2 500€</td><td className="border border-gray-300 p-2 text-right">2 200-4 000€</td><td className="border border-gray-300 p-2 text-right">7 000-12 000€</td></tr>
                  <tr><td className="border border-gray-300 p-2">Plombier</td><td className="border border-gray-300 p-2 text-right">800-1 600€</td><td className="border border-gray-300 p-2 text-right">1 300-2 200€</td><td className="border border-gray-300 p-2 text-right">3 500-6 000€</td></tr>
                  <tr><td className="border border-gray-300 p-2">Électricien</td><td className="border border-gray-300 p-2 text-right">600-1 200€</td><td className="border border-gray-300 p-2 text-right">750-1 800€</td><td className="border border-gray-300 p-2 text-right">3 000-5 000€</td></tr>
                  <tr><td className="border border-gray-300 p-2">Peintre</td><td className="border border-gray-300 p-2 text-right">500-1 000€</td><td className="border border-gray-300 p-2 text-right">600-1 200€</td><td className="border border-gray-300 p-2 text-right">2 200-3 500€</td></tr>
                </tbody>
              </table>
              <p className="text-xs italic text-gray-600">
                Tarif indicatif basé sur les données AQC SYCODÉS 2024 et les barèmes publics des assureurs partenaires.
                Le tarif réel dépend de votre profil et fait l\'objet d\'un devis personnalisé.
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <p>
                L\'absence de garantie décennale est sanctionnée pénalement (art. L. 243-3 du Code des
                assurances)&nbsp;:
              </p>
              <ul>
                <li><strong>75 000 € d\'amende</strong></li>
              ...
              <p>
                De plus, depuis 2024 la mention de votre décennale (assureur, n° de police, période, zone
                géographique couverte) est obligatoire sur tous vos devis et factures clients.
              </p>
            </>
          ),
        },
