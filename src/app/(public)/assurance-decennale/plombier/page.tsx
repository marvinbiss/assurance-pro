    ...
    <PilierLayout
      ...
      benefits={[
        {
          ...
          desc: 'Toute installation plomberie/chauffage = ouvrage soumis à décennale. Sanctions : 75 000 € + 6 mois prison',
        },
        {
          icon: '💧',
        ...
        },
        {
          ...
          desc: 'Couverture spécifique gaz/condensation/PAC + plancher chauffant (malfaçons fréquentes)',
        },
        {
          icon: '💰',
          title: '540-980 €/an AE',
          desc: 'AE plombier CA <50k€. SARL 5 sal : 5 800-12 000€. SAS 10 sal : 12 000-18 000€/an',
        },
      ]}
      sections={[
        {
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'AE plombier (CA <50k€) : 540-980 €/an. EI : 580-1 080 €/an. EURL/SASU : 720-1 320 €/an. SARL 5 salariés : 5 800-12 000 €/an. SAS 10 salariés : 12 000-18 000 €/an. Notre cabinet ORIAS compare 8 assureurs spécialisés BTP (SMABTP, MAAF Pro, April Pro, AXA Pro, Allianz Pro BTP).',
        },
        {
