...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/blog`,
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Assurance Pro — Blog travaux et artisanat' }],
  },
  twitter: {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Conseils, guides de prix et tendances pour vos projets de travaux. Par les experts de Assurance Pro.
            </p>
          </div>
        </div>
      </section>
