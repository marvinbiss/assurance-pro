...
const TAGLINE =
  'La Matmut propose une RC Pro mutualiste accessible aux TPE et associations. Analyse des garanties, tarifs 180-1 200€ par an et comparatif avec Hiscox, MMA, MAIF.'

export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Matmut RC Pro : assureur mutualiste (groupe Matmut + AMF). Plafond 500k€-1.5M€, tarif 180-1 200€ par an. Comparatif Matmut vs MAIF vs MMA vs Hiscox.',
...
export default function Page() {
  return (
    <PilierLayout
      ...
      title={TITLE}
      tagline={TAGLINE}
      intro="La Matmut (Mutuelle Assurance des Travailleurs Mutualistes) est un assureur mutualiste français créé en 1961, devenu un acteur important du marché des particuliers et des TPE ou PME. Son offre RC Pro est moins spécialisée que celle des leaders du segment (Hiscox, Allianz Pro) mais reste pertinente pour les pros déjà clients de la Matmut pour leurs autres assurances (auto, habitation), grâce au pack multi-contrats."
      ...
      benefits={[
        ...
        },
        {
          ...
          desc: 'Standard 500k€ AE, 1M€ SARL ou SAS, 1.5M€ formules étendues',
        },
        {
          icon: '💰',
          title: '180-1 200€ par an',
          ...
          body: (
            <ul>
              <li>
                ...
                auto ou habitation, ajout RC Pro = remise -10-15%
              </li>
              <li>
              ...
              <li>
                <strong>Tarifs compétitifs sur AE</strong> : 180-380€ par an, dans la fourchette
                basse du marché
              </li>
              <li>
        ...
        },
        {
          ...
          body: (
            <ul>
              ...
              <li>
                <strong>MMA Pro</strong> : plus complète, idéal SARL ou SAS PME tous secteurs (y
                compris BTP).
              </li>
              <li>
      ...
      faq={[
        {
          ...
          a: 'Pour un AE freelance services intellectuels (consultant, IT, designer) avec CA &lt; 80k€ : Hiscox ou Stello seront 30-50% moins chers. Matmut devient pertinente si vous êtes déjà client Matmut auto ou habitation (pack multi-contrats -10-15%).',
        },
        {
        ...
        },
        {
          ...
          a: 'Via matmut.fr → onglet &quot;Pro&quot; → &quot;RC Pro&quot;. Devis en ligne possible, finalisation souvent par téléphone / en agence. Délai 24-72h pour attestation.',
        },
        {
          q: 'Matmut vs MAIF pour une asso ?',
          a: 'MAIF leader Asso 1901 (180-300€ par an formule starter, couverture événements). Matmut Asso : 220-380€ par an, garanties proches. MAIF avantage spécialisation et réputation forte sur ESS.',
        },
      ]}
      relatedMetiers={[
