    ...
    <PilierLayout
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'Les assureurs exigent généralement : sauvegardes régulières (3-2-1), authentification multi-facteurs (MFA) pour les accès admin, mises à jour automatiques, formation des employés, plan de réponse à incident documenté.',
        },
        {
          q: 'Délai de prise en charge en cas de cyberattaque ?',
          a: "Assistance 24/7 avec hotline dédiée. Mobilisation des experts forensics sous 4-12h selon contrat. Premier paiement (frais d'urgence) sous 48h. Indemnisation finale après expertise (4-12 semaines).",
        },
        {
          q: 'Et la sanction CNIL pour défaut RGPD ?',
          a: "Selon les contrats, les sanctions CNIL/HADOPI peuvent être couvertes (jusqu'à 4% CA mondial pour RGPD). Mais attention : la couverture des sanctions est juridiquement débattue (principe de non-couverture des amendes). Vérifiez attentivement les exclusions.",
        },
      ]}
    />
  )
