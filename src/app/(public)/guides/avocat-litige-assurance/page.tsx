  ...
  return (
    <PilierLayout
      ...
      benefits={[
        {
          icon: '⚖️',
          title: 'Avocat spécialisé',
          desc: 'Droit des assurances — connaît les arrêts récents de la Cour de cassation',
        },
        {
          icon: '📞',
          title: 'Médiation gratuite',
          desc: "Médiateur de l'assurance (gratuit) résout 70% des litiges sans avocat",
        },
        {
          icon: '💰',
      ...
      sections={[
        {
          ...
          body: (
            <>
              ...
              <ol>
                <li>
                  <strong>Refus d&apos;indemnisation après sinistre majeur</strong> (&gt; 30 000 €)
                  — l&apos;assureur invoque une exclusion contestable, application déchéance,
                  déclaration tardive
                </li>
                <li>
                  <strong>Sous-évaluation manifeste de l&apos;expertise</strong> (écart &gt; 30% vs
                  estimation contradictoire) — refus de l&apos;assureur d&apos;une contre-expertise
                </li>
                <li>
                  <strong>Application abusive de la règle proportionnelle</strong> — l&apos;assureur
                  réduit l&apos;indemnisation alléguant une sous-déclaration que vous contestez
                </li>
                <li>
                  <strong>Application de la déchéance pour fausse déclaration prétendue</strong> —
                  l&apos;assureur invoque l&apos;art. L. 113-8 (déchéance) que vous contestez
                </li>
                <li>
                  <strong>Lenteur prolongée dans le traitement du sinistre</strong> (&gt; 6 mois
                  sans avancée significative) malgré relances — possibilité d&apos;intérêts
                  moratoires + dommages-intérêts
                </li>
              </ol>
              <p>
                Pour les litiges &lt; 10 000 € : la MÉDIATION (gratuite) est généralement plus
                efficace.
              </p>
            </>
          ),
          ...
          body: (
            <>
              ...
              <p>
                ...
                indépendant, saisine gratuite, traitement sous 90 jours. Résout 70% des litiges à
                l&apos;amiable. SAISINE OBLIGATOIRE avant toute action en justice (art. 750-1 CPC).
              </p>
              ...
              <p>
                ...
                complexes mais utile en 1re intention.
              </p>
              <h3>4. Médiation de la consommation</h3>
              <p>
                Si litige B2C ou B2B-B2C, saisine du médiateur de la consommation (gratuit).
                Procédure obligatoire avant toute action judiciaire de plus de 5 000 € (Loi Macron
                2015).
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <ol>
                <li>
                  <strong>Spécialité « droit des assurances »</strong> : vérifier la mention de
                  spécialisation au Conseil de l&apos;Ordre (annuaire avocat.fr). Idéalement avec
                  sous-mention « contentieux assurance »
                </li>
                <li>
                  <strong>Barreau de proximité</strong> : avocat du barreau où la procédure aura
                  lieu (où l&apos;assureur a son siège social ou succursale)
                </li>
                <li>
                  <strong>Expérience contre votre type d&apos;assureur</strong> : MACSF (médecins),
                  SMABTP (BTP), MAAF, Generali, AXA — chaque assureur a des stratégies de défense
                  connues des avocats spécialisés
                </li>
                <li>
                  <strong>Honoraires transparents</strong> : convention d&apos;honoraires écrite
                  OBLIGATOIRE depuis 2015 (Loi Macron). Forfait recommandé sur dossiers complexes (1
                  500-5 000 €)
                </li>
                <li>
                  <strong>Réputation</strong> : avis Google + Trustpilot + recommandations
                  bouche-à-oreille de pairs ayant eu des litiges similaires
                </li>
              </ol>
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border p-2">Saisine référé-expertise</td>
                    <td className="border p-2 text-right">2 500 € – 5 800 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">
                      Action au fond (jusqu&apos;à jugement 1re instance)
                    </td>
                    <td className="border p-2 text-right">5 800 € – 18 000 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Appel</td>
                    <td className="border p-2 text-right">6 800 € – 22 000 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Cassation</td>
                    <td className="border p-2 text-right">8 800 € – 35 000 €</td>
                  </tr>
                </tbody>
              </table>
            </>
          ...
          body: (
            <>
              <ol>
                ...
                <li>
                  <strong>Médiation amiable</strong> (3 mois — OBLIGATOIRE avant action judiciaire
                  art. 750-1 CPC)
                </li>
                <li>
                ...
                <li>
                  ...
                  nomination d&apos;un expert judiciaire (4-8 mois, 1 500-3 000 € d&apos;avance)
                </li>
                <li>
                  <strong>Action au fond</strong> devant le tribunal judiciaire (12-24 mois selon
                  complexité et juridiction)
                </li>
                <li>
                  <strong>Jugement</strong> + exécution (huissier si nécessaire). Possibilité
                  d&apos;appel sous 1 mois après signification
                </li>
              </ol>
              <p className="my-3 border-l-4 border-primary-500 bg-primary-50 p-3">
                ...
                la 1re mise en demeure et le jugement définitif. Prévoir budget temps + financier en
                conséquence. Privilégier MÉDIATION en 1er recours.
              </p>
            </>
          ),
        },
      ...
      faq={[
        {
          q: 'Quand faire appel à un avocat pour un litige assurance ?',
          a: "Pour les sinistres > 30 000€ avec refus d'indemnisation, sous-évaluation manifeste de l'expertise (>30% d'écart), application abusive de la règle proportionnelle, déchéance contestée, ou lenteur prolongée (>6 mois). Pour les litiges < 10 000€ : médiation gratuite via mediation-assurance.org plus efficace que l'avocat.",
        },
        {
          q: 'Combien coûte un avocat spécialisé en droit des assurances ?',
          a: "Consultation initiale : 200-450€. Mise en demeure : 500-1 200€. Référé-expertise : 2 500-5 800€. Action au fond jusqu'à jugement : 5 800-18 000€. Appel : 6 800-22 000€. Convention d'honoraires écrite OBLIGATOIRE depuis Loi Macron 2015. Forfait recommandé sur dossiers complexes.",
        },
        {
          q: 'Avez-vous obligation de passer par un avocat ?',
          a: "NON pour la médiation (mediation-assurance.org, gratuite, 70% de résolution). NON pour les petits litiges (< 5 000€) traitables seul. OUI au-delà de 10 000€ devant le tribunal judiciaire (représentation par avocat OBLIGATOIRE depuis Loi Justice 2019). Cas particulier prud'hommes : avocat non obligatoire mais fortement recommandé.",
        },
        {
        ...
        },
        {
          ...
          a: "Saisine GRATUITE en ligne sur mediation-assurance.org. Conditions cumulatives : (1) avoir épuisé les voies de recours internes auprès de l'assureur (réclamation écrite + relance), (2) litige < 1 an. Délai de traitement : 90 jours. Recommandation du médiateur non contraignante mais suivie dans 80% des cas par les assureurs (engagement professionnel).",
        },
        {
          q: 'Combien de temps dure un litige assurance avec avocat ?',
          a: '18-36 mois entre la 1re mise en demeure et le jugement définitif. Médiation préalable obligatoire : 3 mois. Référé-expertise : 4-8 mois. Action au fond 1re instance : 12-24 mois. Appel : +12-18 mois. Cassation : +12-24 mois. À anticiper en termes de trésorerie (provisions avocat, expertise) et de patience.',
        },
        {
          q: 'Comment trouver un avocat spécialisé en droit des assurances ?',
          a: "(1) Annuaire officiel sur avocat.fr — filtrer par mention de spécialisation « droit des assurances » et sous-mention « contentieux ». (2) Barreau du tribunal compétent (où l'assureur a son siège social). (3) Recommandations de pairs ayant eu litiges similaires. (4) Avis Google + Trustpilot. (5) Notre cabinet ORIAS peut vous orienter vers 3-5 avocats partenaires spécialisés selon votre dossier.",
        },
      ]}
    />
  )
