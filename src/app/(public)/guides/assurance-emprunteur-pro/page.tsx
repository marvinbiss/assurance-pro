/**
 * Pilier — Assurance emprunteur professionnel — crédit pro
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 5) :
 * - 90 vol KD 0 : assurance emprunteur pro btp
 * Volume cumul : 90 • ROI cumul : 22 500 score
 */
...
const SLUG = 'guides/assurance-emprunteur-pro'
const TITLE = "Assurance emprunteur professionnel — crédit pro"
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à assurance emprunteur professionnel — crédit pro. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifique",
      ...
      sections={[
        {
          ...
          body: (
            <div>
              ...
              <li>90 vol KD 0 : assurance emprunteur pro btp</li>
              </ul>
            </div>
          ),
        },
