/**
 * Pilier — Courtier en assurance décennale — sélection
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 70 vol KD 5 : courtier en assurance décennale
 * Volume cumul : 70 • ROI cumul : 46 550 score
 */
...
const SLUG = 'guides/courtier-en-assurance-decennale'
const TITLE = "Courtier en assurance décennale — sélection"
...
const INTRO = "Cette page est dédiée à courtier en assurance décennale — sélection. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 1 KW Ahrefs analysés (volume cumulé 70 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à courtier en assurance décennale — sélection. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "1 KW analysés • 70 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 1 mot-clé validé dans notre base Ahrefs (volume mensuel cumulé : 70). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>70 vol KD 5 : courtier en assurance décennale</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 1 KW analysés Ahrefs montrent un volume marché de 70 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
