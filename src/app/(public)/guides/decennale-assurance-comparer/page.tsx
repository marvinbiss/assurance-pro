/**
 * Pilier — Décennale assurance — méthode comparaison
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 3) :
 * - 400 vol KD 17 : décennale assurance
 * Volume cumul : 400 • ROI cumul : 166 000 score
 */
...
const SLUG = 'guides/decennale-assurance-comparer'
const TITLE = "Décennale assurance — méthode comparaison"
...
const INTRO = "Cette page est dédiée à décennale assurance — méthode comparaison. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 1 KW Ahrefs analysés (volume cumulé 400 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à décennale assurance — méthode comparaison. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "1 KW analysés • 400 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 1 mot-clé validé dans notre base Ahrefs (volume mensuel cumulé : 400). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>400 vol KD 17 : décennale assurance</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 1 KW analysés Ahrefs montrent un volume marché de 400 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
