/**
 * Pilier — Multirisque pro en ligne — souscription digitale
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 150 vol KD null : assurance multirisque pro en ligne
 * - 100 vol KD 0 : assurance multirisque professionnelle en ligne
 * - 100 vol KD null : devis assurance multirisque professionnelle en ligne
 * Volume cumul : 350 • ROI cumul : 205 000 score
 */
...
const SLUG = 'guides/multirisque-pro-en-ligne'
const TITLE = "Multirisque pro en ligne — souscription digitale"
...
const INTRO = "Cette page est dédiée à multirisque pro en ligne — souscription digitale. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 3 KW Ahrefs analysés (volume cumulé 350 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à multirisque pro en ligne — souscription digitale. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiqu",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "3 KW analysés • 350 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 3 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 350). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>150 vol KD null : assurance multirisque pro en ligne</li>
              <li>100 vol KD 0 : assurance multirisque professionnelle en ligne</li>
              <li>100 vol KD null : devis assurance multirisque professionnelle en ligne</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 3 KW analysés Ahrefs montrent un volume marché de 350 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
