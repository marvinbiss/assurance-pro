/**
 * Pilier — Garantie décennale — guide complet
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 3) :
 * - 7200 vol KD 14 : garantie décennale
 * - 200 vol KD 1 : garantie décennale plomberie
 * - 150 vol KD 1 : assurance dommage ouvrage et garantie décennale
 * Volume cumul : 12880 • ROI cumul : 1 233 917 score
 */
...
const SLUG = 'guides/garantie-decennale-comprendre'
const TITLE = "Garantie décennale — guide complet"
...
const INTRO = "Cette page est dédiée à garantie décennale — guide complet. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 94 KW Ahrefs analysés (volume cumulé 12 880 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
const LEGAL_REF = "Loi Spinetta — art. L. 241-1 C. assur. + arrêté 23 janvier 2024 (mentions attestation)"
const BENEFIT_TIER = "Couverture haute valeur — KW à fort volume marché capturés"

export const metadata: Metadata = {
  title: `${TITLE} | Assurance Pro`,
  description: "Cette page est dédiée à garantie décennale — guide complet. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "94 KW analysés • 12 880 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 94 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 12880). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>7200 vol KD 14 : garantie décennale</li>
              <li>200 vol KD 1 : garantie décennale plomberie</li>
              <li>150 vol KD 1 : assurance dommage ouvrage et garantie décennale</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 94 KW analysés Ahrefs montrent un volume marché de 12 880 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
