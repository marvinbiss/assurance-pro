/**
 * Pilier — Comment obtenir attestation responsabilité civile professionnelle ?
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 5) :
 * - 90 vol KD 0 : comment obtenir une attestation de responsabilité civile professionnelle
 * Volume cumul : 90 • ROI cumul : 9 900 score
 */
...
const SLUG = 'guides/comment-obtenir-attestation-rc-civile-pro'
const TITLE = "Comment obtenir attestation responsabilité civile professionnelle ?"
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à comment obtenir attestation responsabilité civile professionnelle ?. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation ",
      ...
      sections={[
        {
          ...
          body: (
            <div>
              ...
              <li>90 vol KD 0 : comment obtenir une attestation de responsabilité civile professionnelle</li>
              </ul>
            </div>
          ),
        },
