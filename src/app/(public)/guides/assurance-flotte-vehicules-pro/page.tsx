/**
 * Pilier — Assurance flotte véhicules pro — gestion 5+ véhicules
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 200 vol KD 0 : assurance flotte automobile professionnelle
 * - 150 vol KD 0 : tarif assurance flotte automobile professionnelle
 * - 40 vol KD 0 : tarif assurance flotte automobile professionnelle forum
 * Volume cumul : 390 • ROI cumul : 116 100 score
 */
...
const SLUG = 'guides/assurance-flotte-vehicules-pro'
const TITLE = "Assurance flotte véhicules pro — gestion 5+ véhicules"
...
const INTRO = "Cette page est dédiée à assurance flotte véhicules pro — gestion 5+ véhicules. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 3 KW Ahrefs analysés (volume cumulé 390 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à assurance flotte véhicules pro — gestion 5+ véhicules. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spéc",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "3 KW analysés • 390 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 3 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 390). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>200 vol KD 0 : assurance flotte automobile professionnelle</li>
              <li>150 vol KD 0 : tarif assurance flotte automobile professionnelle</li>
              <li>40 vol KD 0 : tarif assurance flotte automobile professionnelle forum</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 3 KW analysés Ahrefs montrent un volume marché de 390 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
