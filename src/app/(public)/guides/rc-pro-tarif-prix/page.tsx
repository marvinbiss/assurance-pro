/**
 * Pilier — RC Pro tarif prix 2026 — guide complet
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 300 vol KD 4 : prix assurance rc pro
 * - 250 vol KD 3 : tarif rc pro
 * - 200 vol KD 3 : prix rc pro
 * Volume cumul : 1050 • ROI cumul : 210 825 score
 */
...
const SLUG = 'guides/rc-pro-tarif-prix'
const TITLE = "RC Pro tarif prix 2026 — guide complet"
...
const INTRO = "Cette page est dédiée à rc pro tarif prix 2026 — guide complet. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 5 KW Ahrefs analysés (volume cumulé 1 050 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro tarif prix 2026 — guide complet. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce pr",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "5 KW analysés • 1 050 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 5 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 1050). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>300 vol KD 4 : prix assurance rc pro</li>
              <li>250 vol KD 3 : tarif rc pro</li>
              <li>200 vol KD 3 : prix rc pro</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 5 KW analysés Ahrefs montrent un volume marché de 1 050 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
