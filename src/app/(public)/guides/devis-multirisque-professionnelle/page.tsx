/**
 * Pilier — Devis multirisque professionnelle — comparateur
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 150 vol KD null : devis assurance multirisque professionnelle
 * - 150 vol KD null : devis multirisque professionnelle
 * Volume cumul : 300 • ROI cumul : 195 000 score
 */
...
const SLUG = 'guides/devis-multirisque-professionnelle'
const TITLE = "Devis multirisque professionnelle — comparateur"
...
const INTRO = "Cette page est dédiée à devis multirisque professionnelle — comparateur. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 2 KW Ahrefs analysés (volume cumulé 300 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à devis multirisque professionnelle — comparateur. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifique",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "2 KW analysés • 300 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 2 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 300). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>150 vol KD null : devis assurance multirisque professionnelle</li>
              <li>150 vol KD null : devis multirisque professionnelle</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 2 KW analysés Ahrefs montrent un volume marché de 300 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
