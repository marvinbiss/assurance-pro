/**
 * Pilier — Meilleure assurance décennale 2026 — Top 8 assureurs
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 100 vol KD 1 : meilleur assurance décennale
 * - 100 vol KD 1 : meilleure assurance décennale
 * Volume cumul : 200 • ROI cumul : 94 050 score
 */
...
const SLUG = 'guides/meilleure-assurance-decennale'
const TITLE = "Meilleure assurance décennale 2026 — Top 8 assureurs"
...
const INTRO = "Cette page est dédiée à meilleure assurance décennale 2026 — top 8 assureurs. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 2 KW Ahrefs analysés (volume cumulé 200 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à meilleure assurance décennale 2026 — top 8 assureurs. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spéci",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "2 KW analysés • 200 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 2 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 200). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>100 vol KD 1 : meilleur assurance décennale</li>
              <li>100 vol KD 1 : meilleure assurance décennale</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 2 KW analysés Ahrefs montrent un volume marché de 200 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
