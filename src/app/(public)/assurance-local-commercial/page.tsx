  ...
  return (
    <PilierLayout
      ...
      benefits={[
        {
          icon: '🏢',
          title: 'Multirisque complète',
          desc: 'Incendie, dégâts eaux, vol, vandalisme, événements climatiques, bris glace, RC exploitation',
        },
        {
          icon: '💰',
        ...
        {
          icon: '📜',
          title: 'Obligation bail commercial',
          desc: '100% des baux exigent une assurance MRP — clause de dénonciation possible si défaut',
        },
        {
          icon: '⚡',
          title: "Perte d'exploitation",
          desc: 'Indemnisation des pertes de CA pendant la fermeture suite à sinistre (essentiel pour TPE)',
        },
      ]}
      sections={[
        {
          ...
          body: (
            <>
              <p>
                L&apos;obligation d&apos;assurer un local commercial est{' '}
                <strong>contractuelle et non strictement légale</strong>. Elle découle de deux
                sources :
              </p>
              <ul>
                <li>
                  <strong>Le bail commercial</strong> (cas le plus fréquent) : 100% des baux types
                  signés en France (modèles Loi Pinel 2014) intègrent une clause obligeant le
                  preneur à souscrire une assurance multirisque couvrant a minima : incendie, dégâts
                  des eaux, vol, RC. Le bailleur peut exiger une copie de l&apos;attestation chaque
                  année. Défaut = motif de résiliation du bail.
                </li>
                <li>
                  <strong>Le statut de copropriétaire commerçant</strong> : si vous êtes
                  propriétaire de votre local en copropriété, le règlement de copropriété impose
                  presque toujours une assurance contre les risques d&apos;immeuble (incendie qui se
                  propage, dégâts d&apos;eau qui inondent les voisins).
                </li>
              </ul>
              <p>
                Au-delà de l&apos;obligation contractuelle, l&apos;assurance local commercial est{' '}
                <strong>économiquement indispensable</strong> : un sinistre incendie moyen coûte 75
                000 € à 250 000 € pour un commerce de quartier (rachat stock, remise en état, pertes
                d&apos;exploitation pendant fermeture). Une TPE non assurée ne s&apos;en relève
                généralement pas.
              </p>
            </>
          ),
        },
        {
          ...
          body: (
            <>
              <p>
                Tarifs indicatifs 2026 pour un commerce en France métropolitaine, basés sur les
                barèmes de nos 8 partenaires (Allianz Pro, AXA Pro, MMA Pro, MAAF Pro, Generali,
                Hiscox, April Pro, Wakam) :
              </p>
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border p-2">Atelier artisan (menuiserie, mécanique...)</td>
        ...
        },
        {
          ...
          body: (
            <>
              <ol>
                <li>
                  <strong>Incendie + foudre + explosion</strong> — base de tout contrat MRP. Couvre
                  les dommages au local, au mobilier, aux marchandises stockées.
                </li>
                <li>
                  <strong>Dégâts des eaux</strong> — fuite, infiltration, débordement, gel des
                  canalisations. ATTENTION à la franchise (souvent 250-500€).
                </li>
                <li>
                  <strong>Vol + vandalisme + détérioration</strong> — vérifier que le vol par
                  EFFRACTION DE NUIT est inclus (clause classique d&apos;exclusion).
                </li>
                <li>
                  <strong>Événements climatiques</strong> — tempête, grêle, neige, gel, mouvement de
                  terrain. Catnat (catastrophes naturelles) inclus si état d&apos;urgence déclaré
                  par arrêté.
                </li>
                <li>
                  <strong>Bris de glace</strong> — vitrines, glaces de porte, panneaux
                  publicitaires. Indispensable pour les commerces de rue.
                </li>
                <li>
                  <strong>Responsabilité civile exploitation</strong> — couvre les dommages causés à
                  un tiers (client qui glisse, fournisseur blessé, voisin inondé).
                </li>
                <li>
                  <strong>Perte d&apos;exploitation</strong> — indemnise la perte de chiffre
                  d&apos;affaires pendant la durée de fermeture suite à sinistre. Calcul : marge
                  brute × durée. Souvent oublié, pourtant CRITIQUE pour la survie de la TPE.
                </li>
              </ol>
              <p>Garanties optionnelles selon activité :</p>
              <ul>
        ...
        },
        {
          ...
          body: (
            <>
              <ol>
                <li>
                  <strong>Sous-évaluer la valeur du contenu</strong> (mobilier + matériel + stock) :
                  règle proportionnelle appliquée. Si vous déclarez 30 k€ de contenu mais que la
                  réalité est 60 k€, indemnisation au prorata = 50% du préjudice réel. Faire un
                  inventaire annuel.
                </li>
                <li>
                  <strong>Ne pas activer la clause « valeur à neuf »</strong> : sans elle,
                  indemnisation à valeur d&apos;usage (vétusté déduite) — souvent 50-70% de la
                ...
                <li>
                  <strong>Ne pas installer les protections exigées au contrat</strong> (alarme NF,
                  porte blindée, rideau métallique) : exclusion de garantie en cas de vol.
                </li>
                <li>
                  <strong>
                    Confondre incendie « dommages directs » et « pertes d&apos;exploitation »
                  </strong>{' '}
                  : sans la garantie pertes d&apos;exploitation, vous récupérez le local refait à
                  neuf mais aurez perdu 3-6 mois de CA sans compensation.
                </li>
              </ol>
            </>
          ),
      ...
      faq={[
        {
          q: "L'assurance local commercial est-elle obligatoire ?",
          a: "Pas légalement (sauf cas particuliers : copropriété, ICPE), mais obligatoire CONTRACTUELLEMENT dans 100% des baux commerciaux signés en France. Défaut d'assurance = motif de résiliation du bail. Si vous êtes propriétaire de votre local : obligation contractuelle vis-à-vis du règlement de copropriété.",
        },
        {
        ...
        {
          q: 'Mon assurance local commercial couvre-t-elle le vol par effraction la nuit ?',
          a: "Pas automatiquement. C'est l'une des EXCLUSIONS LES PLUS FRÉQUENTES — à VÉRIFIER explicitement dans les conditions générales. Si exclu, l'assureur exige souvent l'installation d'une alarme certifiée NF en service la nuit + télésurveillance, ou un rideau métallique. Sans ces dispositifs : vol non indemnisé.",
        },
        {
        ...
        },
        {
          ...
          a: 'Devis personnalisé via notre formulaire : 24h ouvrées avec 3 à 5 propositions adaptées (assureurs comparés : Allianz Pro, AXA Pro, MMA, MAAF, Generali, Hiscox, April, Wakam). Souscription : 48h. Effet du contrat : possible dès le 1er du mois suivant ou immédiat selon urgence.',
        },
      ]}
    />
  )
