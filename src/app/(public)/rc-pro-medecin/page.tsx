...
export default function RcProMedecinPage() {
  return (
    <PilierLayout
      ...
      sections={[
        {
          h2: 'Spécialités médicales couvertes',
          body: (
            <>
              <p>
                Notre cabinet propose des contrats RC Pro adaptés aux 15 professions médicales
                suivantes&nbsp;:
              </p>
              <ul>
        ...
        {
          h2: 'Tarifs RC Pro médicale 2026',
          body: (
            <table className="my-4 w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border p-2">Spécialité</th>
                  <th className="border p-2 text-right">Plafond 8M€</th>
                </tr>
              </thead>
              <tbody>
                <tr>
      ...
      faq={[
        {
          q: 'La RC Pro médicale est-elle obligatoire pour un remplaçant ?',
          a: "Oui. La Loi Kouchner s'applique à TOUT professionnel exerçant à titre libéral, y compris les médecins remplaçants et collaborateurs. La RC Pro doit être nominative et active pendant toute la durée du remplacement.",
        },
        {
          q: 'Quel plafond minimum ?',
          a: "La loi n'impose pas de minimum chiffré, mais les compagnies d'assurance proposent généralement 8M€ par sinistre comme standard. Pour les chirurgiens et gynécos-obstétriciens, des plafonds 15-25M€ sont nécessaires.",
        },
        {
          q: 'Que couvre exactement la RC Pro médicale ?',
          a: "Tous les dommages corporels, matériels et immatériels causés à un patient ou à un tiers dans l'exercice de votre art. Cela inclut les fautes de diagnostic, erreurs thérapeutiques, défauts d'information, manquements au devoir d'information.",
        },
        {
          q: 'Garantie subséquente : pourquoi 10 ans ?',
          a: 'Les actions en responsabilité médicale ont une prescription de 10 ans à compter de la consolidation du dommage. La garantie subséquente longue (10 ans) est donc indispensable, notamment pour les chirurgiens et obstétriciens.',
        },
      ]}
    />
  )
