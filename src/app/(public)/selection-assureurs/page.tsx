...
export const metadata: Metadata = {
  ...
  description:
    "Méthodologie de sélection des 10 assureurs partenaires d'Assurance Pro : critères de solvabilité, qualité de gestion sinistres, indépendance, transparence.",
    ...
    <main className="min-h-screen bg-white py-12">
      <div className="prose prose-lg container mx-auto max-w-3xl px-4">
        ...
        <p className="text-sm text-gray-500">
          Indépendance, transparence et qualité — méthodologie publique.
        </p>
        ...
        <p>
          ...
          <strong>25 % de notre chiffre d&apos;affaires</strong>. Cette diversification protège nos
          clients d&apos;une éventuelle pression commerciale qui biaiserait nos recommandations.
        </p>
        ...
        <div className="not-prose my-8 rounded-lg border border-blue-200 bg-blue-50 p-6">
          <h3 className="mb-2 text-xl font-bold">Une question sur nos partenaires&nbsp;?</h3>
          <p className="mb-4 text-sm text-gray-700">
            Nous communiquons sur demande écrite la liste exhaustive des contrats analysés pour
            votre dossier (preuve d&apos;impartialité art. L. 521-4 II).
          </p>
          <Link
            href="/contact"
