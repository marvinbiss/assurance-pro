    ...
    <main className="min-h-screen bg-white py-12">
      <div className="prose prose-lg container mx-auto max-w-3xl px-4">
        ...
        <ul>
          ...
          <li>
            Documents comptables : <strong>5 ans</strong> après la fin du contrat (Code de commerce)
          </li>
          <li>
            LCB-FT : <strong>10 ans</strong> à compter de la fin de la relation (art. L. 561-12 CMF)
          </li>
        ...
        <p>
          ...
          prioriser les rappels commerciaux. Ce profilage n\'a pas d\'impact juridique sur vous : il
          sert uniquement à ajuster le délai de notre rappel. Vous pouvez vous opposer à ce
        ...
        <p>
          ...
          La date de dernière mise à jour figure en haut de la page. Les modifications
