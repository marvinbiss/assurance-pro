...
export const metadata: Metadata = {
  ...
  description: 'Politique de confidentialité de Assurance Pro - Comment nous collectons, utilisons et protégeons vos données personnelles.',
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Assurance Pro — Confidentialité' }],
  },
  twitter: {
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-sm p-8 prose prose-gray max-w-none">
            ...
            <p className="lead">
              Chez Assurance Pro, nous accordons une grande importance à la protection de vos
            ...
            <p>
              Pour exercer ces droits, contactez-nous à : <a href="mailto:dpo@assurance-pro.fr" className="text-blue-600 hover:underline"><strong>dpo@assurance-pro.fr</strong></a>
            </p>
            ...
            <ul>
              <li><strong>Email :</strong> <a href="mailto:dpo@assurance-pro.fr" className="text-blue-600 hover:underline">dpo@assurance-pro.fr</a></li>
