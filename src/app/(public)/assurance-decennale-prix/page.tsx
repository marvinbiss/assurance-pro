/**
 * Pilier — Assurance décennale prix 2026 — guide complet
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 400 vol KD 5 : assurance décennale prix
 * Volume cumul : 400 • ROI cumul : 95 000 score
 */
...
const SLUG = 'assurance-decennale-prix'
const TITLE = "Assurance décennale prix 2026 — guide complet"
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à assurance décennale prix 2026 — guide complet. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques ",
      ...
      sections={[
        {
          ...
          body: (
            <div>
              ...
              <li>400 vol KD 5 : assurance décennale prix</li>
              </ul>
            </div>
          ),
        },
