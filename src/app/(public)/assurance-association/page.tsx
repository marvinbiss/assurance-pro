    ...
    <PilierLayout
      ...
      benefits={[
        {
          ...
          desc: 'Dommages causés aux adhérents (chute, blessure, incident camp/colo) et tiers',
        },
        {
          icon: '👨‍💼',
        ...
        },
        {
          ...
          desc: "Siège, local d'activité, matériel pédagogique/sportif",
        },
        {
          icon: '💰',
          title: 'À partir de 280 €/an',
          desc: 'Petite association < 50 adhérents. Asso sportive 200+ adhérents : 880-1 480€/an',
        },
      ]}
      sections={[
        {
            ...
            <>
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border p-2">Asso éducative (camp/colo enfants)</td>
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'Petite asso < 50 adhérents : 280-480€/an. Asso sportive 100-200 adhérents : 580-980€/an. Asso sportive risque (escalade, équitation, ski) : 880-1 480€/an. Asso éducative camp/colo : 1 200-2 800€/an. Variables : nombre adhérents, activité (sport à risque majoré), présence salariés.',
        },
        {
