/**
 * Pilier — Assurance décennale BTP — pilier 37 métiers
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 3) :
 * - 300 vol KD 12 : assurance décennale btp
 * - 200 vol KD 6 : assurance décennale pro btp
 * - 150 vol KD 5 : assurance décennale btp prix
 * Volume cumul : 960 • ROI cumul : 458 370 score
 */
...
const TITLE = "Assurance décennale BTP — pilier 37 métiers"
...
const INTRO = "Cette page est dédiée à assurance décennale btp — pilier 37 métiers. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 8 KW Ahrefs analysés (volume cumulé 960 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à assurance décennale btp — pilier 37 métiers. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "8 KW analysés • 960 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 8 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 960). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>300 vol KD 12 : assurance décennale btp</li>
              <li>200 vol KD 6 : assurance décennale pro btp</li>
              <li>150 vol KD 5 : assurance décennale btp prix</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 8 KW analysés Ahrefs montrent un volume marché de 960 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
