...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Assurance consultant indépendant : pack RC Pro 5 M€ (clients institutionnels) + mutuelle TNS Madelin + prévoyance + cyber + protection juridique. Tarifs 880-2 200€ par an. Devis ORIAS sous 24h.',
    ...
    <PilierLayout
      ...
      benefits={[
        ...
        },
        {
          ...
          desc: 'Mutuelle + prévoyance déductibles BNC au régime réel (économie ~2 700€ par an pour 80k€ bénéfice)',
        },
        {
          icon: '🔒',
          title: 'Cyber RGPD client',
          desc: 'Manipulation de données sensibles → cyber assurance dédiée recommandée (200-600€ par an)',
        },
        {
          icon: '💰',
          title: 'À partir de 880 € par an',
          desc: 'Junior solo. Senior IT ou finance : 2 800-4 800€ par an (plafond RC 5-10 M€)',
        },
      ]}
      sections={[
        {
            ...
            <>
              <ul>
                ...
                <li>
                  ...
                  — pour consultants en portage ou AE
                </li>
              </ul>
            </>
          ),
      ...
      faq={[
        {
          ...
          a: "OUI absolument — exigée par 100% des clients institutionnels (grands groupes, ETI, collectivités) et 78% des plateformes B2B (Malt, Crème de la Crème). Sans RC Pro : exclusion des appels d'offres + responsabilité personnelle illimitée en cas de mauvais conseil. Tarif accessible : 880-1 400€ par an pour consultant junior solo (plafond 3 M€).",
        },
        {
          q: 'Quel plafond RC Pro pour un consultant ?',
          a: "Junior solo : 3 M€ minimum. Senior management, marketing ou RH : 5 M€. Consultant IT, finance ou cybersécurité : 5-10 M€ (un mauvais conseil sur SI critique d'un grand client peut générer 1-3 M€ de dommages). Conseil financier homologué (CGP ou CIF) : 5 M€ OBLIGATOIRE ACPR.",
        },
        {
          q: "Combien coûte l'assurance d'un consultant indépendant en 2026 ?",
          a: 'Démarre à 880€ par an pour consultant management junior solo (pack RC + mutuelle + prévoyance). Médiane marché : 1 480-2 800€ par an pour consultant senior. Consultant IT senior avec cyber : 2 800-4 800€ par an. Variables : spécialité, CA, plafond RC, présence cyber assurance.',
        },
        {
          q: "Madelin pour consultant : combien d'économie d'impôt ?",
          a: "Plafond Madelin santé + prévoyance pour consultant BNC dégageant 80 k€ : ~6 626€ par an déductibles. À TMI 41% : économie nette ~2 700€ par an + économie cotisations sociales ~24%. Pour consultant à 150 k€ : plafond ~10 305€ par an, économie ~4 200€ par an d'impôts. ROI immédiat sur le coût des assurances.",
        },
        {
          q: 'Consultant en portage salarial : quelle couverture ?',
          a: 'La société de portage salarial vous couvre pour la RC Pro et la mutuelle (régime collectif salarié). MAIS vérifier le PLAFOND RC PRO de votre société de portage — souvent 1,5 M€ standard, INSUFFISANT pour clients institutionnels. Si insuffisant : souscrire une RC Pro complémentaire individuelle (+580-1 200€ par an pour passer à 5 M€).',
        },
        {
          q: 'Cyber assurance : utile pour un consultant ?',
          a: 'OUI si vous manipulez des données sensibles client (CRM, code source, plans stratégiques, documents financiers). Coût moyen sinistre cyber freelance ou consultant : 25 000-80 000€. Cyber dédiée : 200-600€ par an supplémentaires. ROI évident dès le 1er incident.',
        },
        {
