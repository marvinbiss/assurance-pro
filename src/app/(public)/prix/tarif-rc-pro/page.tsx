    ...
    <PilierLayout
      ...
      sections={[
        {
          ...
          body: (
            <ul>
              <li>
                <strong>Consultant freelance IT</strong> : 95-220€/an (best Hiscox/Stello)
              </li>
              <li>
                <strong>Designer / photographe</strong> : 120-250€/an (best Hiscox/Stello)
              </li>
              <li>
                <strong>Coach / formateur</strong> : 150-320€/an (best Hiscox/Allianz Pro)
              </li>
              <li>
                <strong>Coach sportif</strong> : 220-400€/an (best Allianz Pro)
              </li>
              <li>
                <strong>Esthéticienne</strong> : 180-320€/an (best Allianz Pro)
              </li>
              <li>
                <strong>Plombier BTP</strong> : 300-450€/an RC Pro (best April Pro) + 1 400€/an
                décennale
              </li>
              <li>
                <strong>Peintre BTP</strong> : 250-350€/an (best April Pro) + 950€/an décennale
              </li>
              <li>
                <strong>Maçon BTP</strong> : 400-700€/an (best April Pro) + 2 400€/an décennale
              </li>
              <li>
                <strong>VTC</strong> : 280-450€/an (best Wakam/Stello, contrat 2-en-1)
              </li>
              <li>
                <strong>Boutique e-commerce</strong> : 200-350€/an (best Hiscox)
              </li>
            </ul>
          ),
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>SARL services CA 50-100k€</strong> : 350-700€/an (best Hiscox)
              </li>
              <li>
              ...
              <li>
                <strong>SARL services CA 500k-1M€</strong> : 1 400-2 800€/an (best Allianz
                Pro/Hiscox)
              </li>
              <li>
                <strong>SARL BTP 5 salariés</strong> : 600-1 200€/an RC Pro (best April Pro) + 4
                500-8 000€/an décennale
              </li>
              <li>
                <strong>SARL libéral réglementé</strong> (avocat, expert-comptable, etc.) : 800-2
                500€/an (best Allianz Pro/AXA Pro)
              </li>
            </ul>
          ),
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>SAS PME services CA 1-3M€</strong> : 2 500-5 000€/an (best Allianz
                Pro/Hiscox)
              </li>
              <li>
                <strong>SAS PME services CA 3-5M€</strong> : 4 500-8 000€/an (best Allianz Pro/MMA
                Pro)
              </li>
              <li>
                <strong>SAS PME services CA 5-10M€</strong> : 7 000-15 000€/an (négocié via
                courtier)
              </li>
              <li>
                <strong>SAS ESN 20 consultants</strong> : 2 500-8 000€/an RC Pro + 2 000-10 000€/an
                cyber-assurance
              </li>
              <li>
                <strong>SAS BTP 20 salariés</strong> : 2 500-5 000€/an RC Pro + 15 000-25 000€/an
                décennale
              </li>
              <li>
                <strong>SAS immobilier 10 salariés</strong> : 3 500-8 000€/an RC Pro + caution
                Galian/CGI
              </li>
            </ul>
          ),
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'Dépend du profil : AE services = Hiscox/Stello (95-220€/an). AE BTP = April Pro BTP. SARL services = Hiscox/Allianz Pro. SAS PME = négocié via courtier. Toujours comparer 3-5 assureurs.',
        },
        {
