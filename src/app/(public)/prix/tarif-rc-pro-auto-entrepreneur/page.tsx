      ...
      sections={[
        {
          ...
          body: (
            <ul>
              ...
              <li>
                <strong>Designer / photographe</strong> : Hiscox 120-220€/an
              </li>
              <li>
                <strong>Coach / formateur</strong> : Allianz 150-300€/an
              </li>
              <li>
                <strong>Coach sportif / yoga</strong> : Allianz 200-400€/an (risque corporel)
              </li>
              <li>
                <strong>Esthéticienne à domicile</strong> : Allianz 180-350€/an
              </li>
              <li>
                <strong>BTP (en complément décennale)</strong> : April Pro 250-450€/an
              </li>
              <li>
                <strong>VTC AE</strong> : Wakam 280-450€/an (auto + RC Pro 2-en-1)
              </li>
              <li>
                <strong>E-commerce / dropshipping</strong> : Allianz 200-450€/an
              </li>
              <li>
                <strong>Food truck / restauration</strong> : Allianz 350-700€/an
              </li>
              <li>
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>Hiscox</strong> : 🥇 best AE services intellectuels (95-220€/an,
                postériorité 10 ans)
              </li>
              <li>
                <strong>Stello</strong> : challenger digital pure (90-200€/an, postériorité 5 ans)
              </li>
              <li>
                <strong>Allianz Pro</strong> : couverture large multi-secteurs (180-380€/an)
              </li>
              <li>
                <strong>MMA Pro</strong> : équilibré, réseau agences (250-450€/an)
              </li>
              <li>
                <strong>April Pro BTP</strong> : 🥇 best AE BTP (250-450€/an + décennale)
              </li>
            </ul>
          ),
        },
      ...
      faq={[
        {
          ...
          a: 'AE consultant services CA &lt; 50k€ : 95-150€/an chez Hiscox (best price), plafond 1M€, postériorité 10 ans. Cyber-assurance combinée : +150-300€/an si données client.',
        },
        {
          q: 'Comment réduire tarif RC Pro AE ?',
          a: '1) Hiscox/Stello vs assureurs traditionnels (-30-50%). 2) Plafond 500k€ si CA &lt; 30k€ (-15%). 3) Franchise 800€ vs 300€ (-10%). 4) Paiement annuel (-3%). 5) Pack multi-contrats (-10%). Cumul : -30-50%.',
        },
        {
          q: 'Tarif AE BTP plombier ?',
          a: 'AE plombier RC Pro chez April Pro : 350-450€/an. À combiner avec décennale obligatoire : 1 400-2 100€/an. Pack = 1 750-2 550€/an total.',
        },
      ]}
      relatedMetiers={[
        {
