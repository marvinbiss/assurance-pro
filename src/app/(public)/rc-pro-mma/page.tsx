...
const TAGLINE =
  "MMA Pro propose une RC Pro équilibrée pour SARL ou SAS PME : analyse des garanties, tarifs 250-2 500€ par an, retours d'adhérents et comparatif avec Hiscox, Allianz Pro, AXA."

export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'MMA RC Pro : assureur paritaire historique (groupe MMA). Plafond 500k€-3M€, postériorité 5 ans. Tarif 250-2 500€ par an. Comparatif Hiscox, Allianz, AXA, Generali.',
...
export default function Page() {
  return (
    <PilierLayout
      ...
      title={TITLE}
      tagline={TAGLINE}
      intro="MMA (Mutuelles du Mans Assurance) est l'un des assureurs paritaires historiques français (fondé en 1828), membre du groupe Covéa avec MAAF et GMF. MMA Pro propose une RC Pro couvrant tous secteurs (services, BTP, commerce, médical) avec un bon équilibre prix ou garanties pour SARL ou SAS PME (100-500k€ CA). Cette page analyse l'offre MMA RC Pro, ses points forts ou faibles, et la compare avec Hiscox, Allianz Pro, AXA Pro, Generali."
      ...
      benefits={[
        ...
        },
        {
          ...
          desc: 'Standard 1M€ AE, jusqu&apos;à 3M€ SARL ou SAS PME',
        },
        {
          icon: '💰',
          title: '250-2 500€ par an',
          desc: 'AE 250-450€ • SARL services 600-1 200€ • SAS PME 1 200-2 500€',
        },
        {
          icon: '🏗️',
          title: 'Couverture BTP incluse',
          desc: 'Contrairement à Hiscox ou Stello, MMA fait aussi BTP + décennale',
        },
      ]}
      sections={[
        {
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>Tarifs AE freelance services pas les plus compétitifs</strong> : 250-450€
                par an vs 95-180€ chez Hiscox ou Stello sur ce segment.
              </li>
              <li>
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>MMA Pro</strong> : équilibré tous secteurs, idéal SARL ou SAS PME 100-500k€
                CA, réseau agences. Postériorité 5 ans.
              </li>
              <li>
              ...
              <li>
                ...
                rapport prix ou services SARL ou SAS. Postériorité 5 ans.
              </li>
              <li>
      ...
      faq={[
        {
          ...
          a: 'Pour un AE ou freelance services intellectuels (consultant, IT, designer) avec CA &lt; 80k€, Hiscox ou Stello seront généralement 30-50% moins chers que MMA. MMA devient compétitif à partir de SARL ou SAS avec CA 100k€+.',
        },
        {
        ...
        },
        {
          ...
          a: 'Toutes trois font partie du groupe Covéa (créé 2003). MMA est le pôle dédié pro ou entreprises. MAAF est plutôt particuliers et TPE. GMF cible les fonctionnaires. En RC Pro, c&apos;est MMA qu&apos;il faut viser.',
        },
        {
