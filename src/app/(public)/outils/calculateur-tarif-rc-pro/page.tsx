...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Estimation tarif RC Pro en 30 secondes. 8 assureurs comparés. Devis officiel 24h.",
    url: `${SITE_URL}/${SLUG}`,
    type: 'website',
  },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      {/* HERO */}
      <header className="bg-gradient-to-br from-blue-700 to-cyan-900 text-white py-12">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl font-bold mb-2">Renseignez votre profil professionnel</h2>
          <p className="text-gray-600 mb-6">
            Le calcul est <strong>100% côté navigateur</strong> — vos données ne sont pas envoyées
            à nos serveurs. Estimation indicative basée sur barèmes mutualisés ACPR + AMRAE 2024
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl font-bold mb-4">Comment est calculé votre tarif RC Pro ?</h2>
          ...
          <table className="w-full text-sm border-collapse bg-white">
            ...
            <tbody>
              <tr>
                <td className="border p-2"><strong>Secteur d&apos;activité</strong></td>
                <td className="border p-2">Tarif base 90-4 200 €/an (consultant → médecin libéral)</td>
              ...
              <tr>
                <td className="border p-2"><strong>Plafond garantie</strong></td>
                <td className="border p-2">Coef ×0,78 (150k€) à ×1,85 (5M€)</td>
                <td className="border p-2">Niveau exposition souhaité</td>
              </tr>
              <tr>
                <td className="border p-2"><strong>Ancienneté d&apos;activité</strong></td>
          ...
          <p className="mt-4 text-xs text-gray-600 italic">
            Formule : <code className="bg-white px-1 py-0.5 rounded">Tarif = Base × CA × Forme × Effectif × Antécédents × Franchise × Plafond × Ancienneté</code>.
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl font-bold mb-4">Tarifs RC Pro 2026 indicatifs (auto-entrepreneur, CA 50k€)</h2>
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              <tr><td className="border p-2">Consultant / conseil</td><td className="border p-2 text-right">90 € – 280 €</td><td className="border p-2">1,2 %</td></tr>
              <tr><td className="border p-2">Photographe / graphiste</td><td className="border p-2 text-right">110 € – 290 €</td><td className="border p-2">1,3 %</td></tr>
              <tr><td className="border p-2">Marketing / communication</td><td className="border p-2 text-right">110 € – 320 €</td><td className="border p-2">1,8 %</td></tr>
              <tr><td className="border p-2">Formateur / coach</td><td className="border p-2 text-right">130 € – 380 €</td><td className="border p-2">1,5 %</td></tr>
              <tr><td className="border p-2">Informatique / SaaS</td><td className="border p-2 text-right">180 € – 480 €</td><td className="border p-2">2,1 % (RGPD)</td></tr>
              <tr><td className="border p-2">Esthétique / bien-être</td><td className="border p-2 text-right">180 € – 540 €</td><td className="border p-2">2,2 %</td></tr>
              <tr><td className="border p-2">Santé paramédical</td><td className="border p-2 text-right">220 € – 680 €</td><td className="border p-2">2,7 %</td></tr>
              <tr><td className="border p-2">Commerce de détail</td><td className="border p-2 text-right">240 € – 720 €</td><td className="border p-2">3,1 %</td></tr>
              <tr><td className="border p-2">Agent immobilier</td><td className="border p-2 text-right">280 € – 920 €</td><td className="border p-2">4,1 %</td></tr>
              <tr><td className="border p-2">Restaurateur / traiteur</td><td className="border p-2 text-right">320 € – 980 €</td><td className="border p-2">4,8 %</td></tr>
              <tr><td className="border p-2">Avocat / juridique</td><td className="border p-2 text-right">380 € – 1 180 €</td><td className="border p-2">3,2 %</td></tr>
              <tr><td className="border p-2">VTC / transport</td><td className="border p-2 text-right">380 € – 1 180 €</td><td className="border p-2">4,5 %</td></tr>
              <tr><td className="border p-2">Expert-comptable</td><td className="border p-2 text-right">420 € – 1 280 €</td><td className="border p-2">3,8 %</td></tr>
              <tr><td className="border p-2">Médecin libéral</td><td className="border p-2 text-right">480 € – 4 200 €</td><td className="border p-2">5,1 %</td></tr>
            </tbody>
          </table>
      ...
      <section className="py-8 bg-amber-50 border-y border-amber-200">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-sm">
            ...
            les assureurs (Recommandation ACPR 2024-R-02). Le tarif réel peut varier ±20% selon :
            précision codes NAF, relevé d&apos;information détaillé (5 ans), garanties optionnelles
            (RC exploitation, défense pénale, protection juridique, cyber assurance, dommages aux
            biens), franchises spécifiques par garantie.
            <br />
            <br />
      ...
      {/* CTA souscription */}
      <section className="py-12 bg-gradient-to-br from-blue-600 to-cyan-700 text-white">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl font-bold mb-6">FAQ — Tarif RC Pro 2026</h2>
          <div className="space-y-5">
            <details className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r">
              <summary className="cursor-pointer font-semibold">Pourquoi tant d&apos;écart entre 90 € et 12 000 €/an ?</summary>
              <p className="mt-2 text-sm">
                ...
                médecin 5,1% vs consultant 1,2% ; (3) le plafond garantie qui peut varier de
                150k€ (×0,78) à 5M€ (×1,85). Notre calculateur applique ces 7 coefficients pour
                vous donner la fourchette précise à votre profil.
              </p>
            </details>
            <details className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r">
              <summary className="cursor-pointer font-semibold">RC Pro est-elle obligatoire ?</summary>
              <p className="mt-2 text-sm">
                ...
                CGP/CIF, agents de voyage, taxis/VTC, transport marchandises. <strong>Fortement
                recommandée</strong> (mais non obligatoire) pour : consultants, IT, marketing,
                photographes, formateurs, commerces. Sans RC Pro et en cas de sinistre = patrimoine
                personnel engagé.
              </p>
            </details>
            <details className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r">
              ...
              <p className="mt-2 text-sm">
                ...
                = -8% sur cotisation) ; (2) <strong>réduire le plafond garantie</strong> si activité
                à faible exposition (de 1M€ à 500k€ = -15%) ; (3) <strong>regrouper RC Pro +
                multirisque + cyber</strong> chez le même assureur (rabais multi-contrats 5-12%) ;
                (4) <strong>fournir un relevé d&apos;information sans sinistre</strong> (-15% bonus
                fidélité après 5 ans). Notre cabinet ORIAS optimise ces leviers dans chaque devis.
              </p>
            </details>
            <details className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r">
              <summary className="cursor-pointer font-semibold">RC Pro : déductible fiscalement ?</summary>
              <p className="mt-2 text-sm">
                OUI à 100%. La cotisation RC Pro est une charge professionnelle déductible
                (CGI art. 39-1). Pour AE : déductible du CA déclaré. Pour EURL/SARL/SAS :
                charge déductible du résultat fiscal IS. Économie réelle : 15-25% du tarif brut
                selon votre TMI.
              </p>
            </details>
            <details className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r">
              <summary className="cursor-pointer font-semibold">Plafond garantie : quel niveau choisir ?</summary>
              <p className="mt-2 text-sm">
                Recommandations selon profil : <strong>150 000 €</strong> = AE solo activité faible
                exposition (consultant junior, photographe événementiel) ; <strong>500 000 €</strong>
                = standard TPE (commerce, restaurant, agence) ; <strong>1 000 000 €</strong> = PME
                ou activité sensible (IT manipulant données client, formateur entreprise) ;
                <strong> 2 000 000 € à 5 000 000 €</strong> = professions réglementées avec
                contrats publics ou exposition majeure (médecin libéral, avocat affaires, expert
                judiciaire, architecte gros chantiers).
              </p>
            </details>
          </div>
        </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebApplication',
            name: 'Calculateur tarif RC Pro 2026 — Assurance Pro',
            url: `${SITE_URL}/${SLUG}`,
