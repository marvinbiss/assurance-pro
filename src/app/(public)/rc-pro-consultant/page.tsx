...
const TAGLINE =
  'La RC Pro consultant couvre les conseils erronés, retards livraison, fautes de gestion. Tarifs 95-1 500€ par an selon spécialité et CA. Hiscox leader segment.'

export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'RC Pro consultant : tarif AE 95-220€ par an, SARL 350-1 500€ par an. Couvre erreurs conseil, fautes gestion, retards. Hiscox leader, Stello challenger digital.',
...
export default function Page() {
  return (
    <PilierLayout
      ...
      title={TITLE}
      tagline={TAGLINE}
      intro="La RC Pro consultant est l'assurance professionnelle indispensable pour tout consultant indépendant ou cabinet de conseil : management ou stratégie, marketing, RH, finance ou business, IT, formation, coaching. Elle couvre les dommages causés à un client en cas d'erreur de conseil, faute de gestion, retard de livraison majeur ou conseil financier inadapté. Sinistre moyen consultant : 30-80k€ (correction projet, perte CA client, dommages moraux)."
      ...
      sections={[
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>AE freelance management ou stratégie</strong> (CA &lt; 80k€) : 95-220€ par
                an, plafond 500k€-1M€
              </li>
              <li>
                <strong>AE consultant marketing, RH ou finance</strong> : 120-280€ par an
              </li>
              <li>
                <strong>AE coach professionnel</strong> : 150-350€ par an
              </li>
              <li>
                <strong>SARL ou SASU conseil (CA 100-300k€)</strong> : 350-900€ par an, plafond
                1-2M€
              </li>
              <li>
                <strong>SAS PME conseil (CA 300k-1M€)</strong> : 800-1 500€ par an, plafond 2-5M€
              </li>
              <li>
                <strong>Cabinet conseil senior (CA &gt; 1M€)</strong> : 1 500-5 000€ par an+,
                plafond 5-10M€
              </li>
              <li>
                <strong>Conseil financier réglementé (CIF)</strong> : 1 200-8 000€ par an (plafond
                5M€ minimum AMF)
              </li>
            </ul>
          ),
      ...
      faq={[
        {
          ...
          a: 'Pour AE consultant management ou stratégie CA &lt; 80k€ : Hiscox ou Stello = best price 95-220€ par an avec plafond 1M€. Si CA &gt; 100k€ ou conseil financier : Hiscox Premium ou Allianz Pro (350-900€ par an, plafond 2M€+).',
        },
        {
          q: 'Quel plafond pour un consultant management ?',
          a: 'Pour AE freelance CA &lt; 80k€ : 500k€-1M€ suffisent. Pour SARL ou SAS CA &gt; 200k€ : 2-3M€ recommandés. Conseil financier réglementé (CIF) : 5M€ minimum AMF.',
        },
        {
        ...
        },
        {
          ...
          a: 'Cabinet conseil PME 5-15 consultants : 1 500-5 000€ par an chez Hiscox ou Allianz Pro. Pour gros cabinet (50+ consultants, CA &gt; 5M€) : 8 000-50 000€ par an avec couverture cyber combinée recommandée.',
        },
      ]}
      relatedMetiers={[
