/**
 * Pilier — RC Pro freelance informatique 2026
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 150 vol KD 0 : rc pro freelance informatique
 * - 30 vol KD null : assurance rc pro freelance informatique
 * Volume cumul : 180 • ROI cumul : 96 000 score
 */
...
const TITLE = "RC Pro freelance informatique 2026"
...
const INTRO = "Cette page est dédiée à rc pro freelance informatique 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 2 KW Ahrefs analysés (volume cumulé 180 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro freelance informatique 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "2 KW analysés • 180 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 2 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 180). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>150 vol KD 0 : rc pro freelance informatique</li>
              <li>30 vol KD null : assurance rc pro freelance informatique</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 2 KW analysés Ahrefs montrent un volume marché de 180 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
