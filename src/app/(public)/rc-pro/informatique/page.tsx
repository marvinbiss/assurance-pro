...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'RC Pro informatique : couverture freelance dev, ESN, agences digitales, DevOps. Plafonds recommandés 5-10 M€ (gestion de système critique). Cyber assurance couplée recommandée. Tarifs négociés à partir de 380 € par an. Devis gratuit ORIAS sous 24h.',
      ...
      benefits={[
        {
          ...
          desc: 'Dev freelance, ESN ou SSII, agences web, DevOps, cybersécurité, data scientist, consultant IT, integrateur',
        },
        {
          icon: '🛡️',
          title: 'Plafond 5-10 M€',
          desc: 'Standard 1,5 M€ INSUFFISANT pour IT critique. Recommandé 5 M€ minimum, 10 M€ pour systèmes bancaires ou santé',
        },
        {
          icon: '🔒',
          title: 'Cyber assurance couplée',
          desc: 'RC Pro standard NE COUVRE PAS les cyberattaques. Cyber assurance dédiée recommandée (+200-800€ par an)',
        },
        {
          icon: '💰',
          title: 'Tarif 380-2 800 € par an',
          desc: 'Freelance dev solo : 380-680€ par an (5 M€). ESN 10 personnes : 2 800-5 800€ par an',
        },
      ]}
      sections={[
        {
          ...
          body: (
            <>
              ...
              <p>
                <strong>Recommandation</strong> : plafond minimum 5 M€ par sinistre pour TOUT métier
                IT. Pour les systèmes critiques (banque, santé, énergie, télécoms) : 10 M€ minimum.
              </p>
            </>
          ),
        },
                ...
                <tbody>
                  <tr>
                    <td className="border p-2">
                      Freelance dev web (front-end ou back-end), CA &lt; 60k€
                    </td>
                  ...
                  <tr>
                    <td className="border p-2">ESN bancaire ou santé 30+ personnes</td>
          ...
          body: (
            <>
              ...
              <p className="mt-3">
                ...
                contrats). Une cyber assurance dédiée coûte 200-800 € par an supplémentaires — ROI
          ...
          body: (
            <>
              <ul>
                ...
                <li>
                  <strong>Pertes financières SEULES</strong> sans dommage matériel ou corporel :
      ...
      faq={[
        {
          ...
          a: "Oui — fortement recommandée même si pas légalement obligatoire pour le métier de développeur. 78% des plateformes B2B (Malt, Crème de la Crème, Comeup Pro, Upwork) exigent une attestation RC Pro à l'inscription. Sans elle, accès aux missions B2B fortement limité. Tarif accessible : 380-580€ par an pour un freelance dev solo (plafond 3 M€).",
        },
        {
          q: 'Quel plafond RC Pro choisir pour un freelance IT ?',
          a: 'Minimum 5 M€ par sinistre pour TOUT freelance IT — le plafond standard 1,5 M€ est INSUFFISANT pour le secteur. Pour cybersécurité, conseil bancaire ou santé, gestion de systèmes critiques : 10 M€ minimum. Justification : un seul sinistre sur un client à 50 M€ de CA peut générer 1-3 M€ de dommages-intérêts (perte CA client + sanctions RGPD répercutées).',
        },
        {
          q: 'Combien coûte une RC Pro pour un freelance dev en 2026 ?',
          a: 'Démarre à 380€ par an pour un freelance dev web junior (plafond 3 M€). Médiane marché : 580-980€ par an pour un freelance dev senior (plafond 5 M€). DevOps ou SRE : 780-1 280€ par an. Cybersécurité : 1 480-2 380€ par an (plafond 10 M€). Variables : CA déclaré, antécédents, certifications, type clientèle.',
        },
        {
          q: 'RC Pro et Cyber assurance : faut-il les 2 ?',
          a: "OUI pour 95% des métiers IT. La RC Pro standard NE COUVRE PAS les cyberattaques (exclusion explicite). Coût d'un sinistre cyber type pour un freelance IT : 25 000-150 000€ (notification CNIL, frais juridiques RGPD, perte d'exploitation, restauration de données). Cyber assurance dédiée : 200-800€ par an supplémentaires. ROI évident.",
        },
        {
          q: 'ESN — SSII : quelles garanties indispensables ?',
          a: 'Pack standard ESN : (1) RC Pro 5-10 M€ avec dommages immatériels NON consécutifs, (2) Cyber assurance 1-3 M€, (3) RC Mandataire social pour le dirigeant (1-2 M€), (4) Multirisque bureau ou serveur, (5) Mutuelle collective salariés (ANI 2013). Tarif global 5-15k€ par an pour ESN 10 personnes, 18-40k€ par an pour ESN 30+.',
        },
        {
          q: 'Mon code open source GPL est dans le projet client : suis-je couvert ?',
          a: "Pas systématiquement. La violation involontaire d'une licence open source contaminante (GPL, AGPL) qui obligerait votre client à publier son code propriétaire peut générer un sinistre RC Pro… SOUS CONDITION que la garantie « violation propriété intellectuelle » soit incluse. Cette garantie est SOUVENT EN OPTION dans les contrats entrée de gamme (+150-400€ par an). À demander explicitement à la souscription.",
        },
        {
