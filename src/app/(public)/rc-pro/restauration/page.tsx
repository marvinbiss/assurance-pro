/**
 * Pilier — RC Pro restauration 2026 — restaurateurs/traiteurs
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 150 vol KD 1 : assurance professionnelle restauration
 * Volume cumul : 150 • ROI cumul : 89 100 score
 */
...
const SLUG = 'rc-pro/restauration'
const TITLE = "RC Pro restauration 2026 — restaurateurs/traiteurs"
...
const INTRO = "Cette page est dédiée à rc pro restauration 2026 — restaurateurs/traiteurs. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 1 KW Ahrefs analysés (volume cumulé 150 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro restauration 2026 — restaurateurs/traiteurs. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifi",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "1 KW analysés • 150 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 1 mot-clé validé dans notre base Ahrefs (volume mensuel cumulé : 150). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>150 vol KD 1 : assurance professionnelle restauration</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 1 KW analysés Ahrefs montrent un volume marché de 150 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
