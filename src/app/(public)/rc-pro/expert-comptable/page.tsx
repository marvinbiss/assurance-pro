      ...
      benefits={[
        {
          ...
          desc: 'Inscription Ordre Experts-Comptables impose RC Pro avec plafond 600 000€/sinistre + 1,2M€/an',
        },
        {
          icon: '📊',
        ...
        {
          icon: '💰',
          title: '420-1 280 €/an indépendant',
          desc: 'EC indépendant CA 80-180k€. Cabinet SARL 5 sal : 8 500-22 000€/an. SAS 10+ : 22 000-45 000€/an',
        },
      ]}
      sections={[
        {
          ...
          body: (
            <div>
              ...
              <ul>
                ...
                <li>
                  <strong>Défaut conseil patrimonial (22%)</strong> — mauvaise structuration
                  holding/SCI, optimisation ratée
                </li>
                <li>
              ...
              <p className="mt-3 border-l-4 border-primary-500 bg-primary-50 p-3">
                ...
                000€). Plafond Ordre 600 000€ INSUFFISANT pour cabinets avec clients ETI/grandes
      ...
      faq={[
        {
          ...
          a: 'Suffisant pour expert-comptable indépendant avec clientèle TPE/PME (CA <500k€). INSUFFISANT pour : cabinet avec clients ETI ou grandes structures (recours peuvent dépasser 1M€), missions de conseil M&A/évaluation entreprises, mandats commissariat aux comptes (CAC). Recommandation : 2-5 M€ pour cabinets >5 salariés.',
        },
        {
          q: 'Cyber assurance obligatoire EC ?',
          a: 'Pas légalement OBLIGATOIRE mais FORTEMENT recommandée. EC = manipulation données fiscales/sociales sensibles + obligation RGPD. Sinistre cyber 2024 moyen EC : 85 000€ (notification CNIL + restauration + perte clients). Notre cabinet ORIAS propose pack RC Pro + cyber +200-500€/an.',
        },
        {
          q: 'Tarif RC Pro EC 2026 ?',
          a: 'EC indépendant (CA 80-180k€) : 420-1 280 €/an. EURL/SASU : 580-1 580 €/an. Cabinet SARL 5 salariés : 8 500-22 000 €/an. SAS 10+ salariés : 22 000-45 000 €/an. Variables : plafond souhaité (au-dessus 600k€ Ordre = sur-prime), antécédents, présence CAC, clientèle ETI.',
        },
        {
