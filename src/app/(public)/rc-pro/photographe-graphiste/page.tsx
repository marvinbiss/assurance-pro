/**
 * Pilier — RC Pro photographe & graphiste 2026
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 90 vol KD 0 : rc pro photographe
 * - 60 vol KD null : assurance rc pro photographe
 * Volume cumul : 150 • ROI cumul : 60 000 score
 */
...
const SLUG = 'rc-pro/photographe-graphiste'
const TITLE = "RC Pro photographe & graphiste 2026"
...
const INTRO = "Cette page est dédiée à rc pro photographe & graphiste 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 2 KW Ahrefs analysés (volume cumulé 150 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro photographe & graphiste 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profi",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "2 KW analysés • 150 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 2 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 150). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>90 vol KD 0 : rc pro photographe</li>
              <li>60 vol KD null : assurance rc pro photographe</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 2 KW analysés Ahrefs montrent un volume marché de 150 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
