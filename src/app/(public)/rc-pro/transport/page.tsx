/**
 * Pilier — RC Pro transport 2026 (marchandises + voyageurs)
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 200 vol KD 1 : assurance professionnelle transport de marchandises
 * - 150 vol KD 0 : rc pro transport de personnes
 * - 80 vol KD 0 : rc pro transport de marchandises
 * Volume cumul : 560 • ROI cumul : 206 100 score
 */
...
const SLUG = 'rc-pro/transport'
const TITLE = "RC Pro transport 2026 (marchandises + voyageurs)"
...
const INTRO = "Cette page est dédiée à rc pro transport 2026 (marchandises + voyageurs). Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 6 KW Ahrefs analysés (volume cumulé 560 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro transport 2026 (marchandises + voyageurs). Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiqu",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "6 KW analysés • 560 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 6 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 560). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>200 vol KD 1 : assurance professionnelle transport de marchandises</li>
              <li>150 vol KD 0 : rc pro transport de personnes</li>
              <li>80 vol KD 0 : rc pro transport de marchandises</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 6 KW analysés Ahrefs montrent un volume marché de 560 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
