    ...
    <PilierLayout
      ...
      benefits={[
        {
          ...
          desc: 'Mauvaise utilisation fer/eau chaude — sinistre type 2 000-15 000€',
        },
        {
          icon: '⚠️',
        ...
        },
        {
          ...
          desc: 'AE coiffeur à domicile. Salon 3 salariés : 580-1 200€/an',
        },
      ]}
      sections={[
        {
      ...
      faq={[
        ...
        },
        {
          ...
          a: "AE coiffeur à domicile : 220-380€/an. Barbier solo en boutique : 380-580€/an. Salon 2 salariés : 580-880€/an. Salon 5 salariés : 880-1 480€/an. Variables : surface, présence salariés, type d'actes (esthétique combinée majoré).",
        },
        {
          q: 'Coiffeur à domicile : assurance habitation suffit ?',
          a: "NON — l'assurance habitation classique ne couvre PAS l'activité pro à domicile. Il faut soit étendre l'habitation (option « activité pro à domicile » +80-150€/an) soit souscrire une RC Pro coiffeur dédiée (220-380€/an). Voir <a href='/assurance-habitation-professionnelle' class='text-primary-600 underline'>/assurance-habitation-professionnelle</a>.",
        },
      ]}
    />
  )
