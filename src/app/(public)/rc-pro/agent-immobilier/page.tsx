/**
 * Pilier — RC Pro agent immobilier 2026 (Loi Hoguet)
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 200 vol KD 1 : rc pro agent immobilier
 * - 150 vol KD null : tarif rc pro agent immobilier
 * - 90 vol KD null : assurance rc pro agent immobilier
 * Volume cumul : 500 • ROI cumul : 189 000 score
 */
...
const TITLE = "RC Pro agent immobilier 2026 (Loi Hoguet)"
...
const INTRO = "Cette page est dédiée à rc pro agent immobilier 2026 (loi hoguet). Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 4 KW Ahrefs analysés (volume cumulé 500 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro agent immobilier 2026 (loi hoguet). Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "4 KW analysés • 500 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 4 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 500). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>200 vol KD 1 : rc pro agent immobilier</li>
              <li>150 vol KD null : tarif rc pro agent immobilier</li>
              <li>90 vol KD null : assurance rc pro agent immobilier</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 4 KW analysés Ahrefs montrent un volume marché de 500 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
