/**
 * Pilier — RC Pro artisan 2026
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 100 vol KD null : rc pro artisan
 * - 80 vol KD null : responsabilité civile professionnelle artisan
 * Volume cumul : 180 • ROI cumul : 98 000 score
 */
...
const SLUG = 'rc-pro/artisan'
const TITLE = "RC Pro artisan 2026"
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro artisan 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation in",
      ...
      sections={[
        {
          ...
          body: (
            <div>
              ...
              <li>100 vol KD null : rc pro artisan</li>
              <li>80 vol KD null : responsabilité civile professionnelle artisan</li>
              </ul>
            </div>
          ),
        },
