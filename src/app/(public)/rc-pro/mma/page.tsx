/**
 * Pilier — RC Pro MMA Pro — analyse complète 2026
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 4) :
 * - 350 vol KD 5 : mma rc pro
 * Volume cumul : 350 • ROI cumul : 83 125 score
 */
...
const TITLE = "RC Pro MMA Pro — analyse complète 2026"
...
const INTRO = "Cette page est dédiée à rc pro mma pro — analyse complète 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 1 KW Ahrefs analysés (volume cumulé 350 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à rc pro mma pro — analyse complète 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce pr",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "1 KW analysés • 350 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 1 mot-clé validé dans notre base Ahrefs (volume mensuel cumulé : 350). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>350 vol KD 5 : mma rc pro</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 1 KW analysés Ahrefs montrent un volume marché de 350 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
