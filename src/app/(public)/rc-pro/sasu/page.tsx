...
export default function Page() {
  return (
    <PilierLayout
      ...
      benefits={[
        {
          icon: '👔',
          title: 'Statut SASU',
          desc: 'Couverture adaptée président assimilé salarié + société',
        },
        {
          icon: '🛡️',
          title: 'RCMS dirigeant',
          desc: 'Protection responsabilité personnelle président SASU (faute de gestion)',
        },
        {
          icon: '🏥',
          title: 'Mutuelle collective',
          desc: "Régime collectif d'entreprise possible (vs Madelin TNS)",
        },
        {
          icon: '💰',
      ...
      faq={[
        {
          q: 'RC Pro SASU : différence avec RC Pro classique ?',
          a: "Aucune sur le contrat lui-même — la SASU souscrit comme n'importe quelle société. La différence porte sur la MUTUELLE et la PRÉVOYANCE : le président SASU est ASSIMILÉ SALARIÉ (régime collectif possible vs Madelin TNS pour SARL gérant majoritaire). Voir <a href='/assurance-sasu' class='text-primary-600 underline'>/assurance-sasu</a>.",
        },
        {
