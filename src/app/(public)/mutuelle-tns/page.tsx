...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    "Mutuelle TNS Loi Madelin : déduisez vos cotisations santé du résultat imposable (jusqu'à 5 800€ par an). Comparatif April, MMA, Generali, Aon. Tarifs à partir de 32€ par mois. Devis gratuit ORIAS sous 24h.",
    ...
    <PilierLayout
      ...
      benefits={[
        {
          ...
          desc: "Jusqu'à 5 800€ par an déduits du résultat (bénéfice 60k€). Économie d'impôt réelle",
        },
        {
          icon: '🩺',
            ...
            <>
              ...
              <ul>
                ...
                <li>
                  ...
                  ou avec conjoint ou enfants mineurs)
                </li>
                <li>
              ...
              <p>
                ...
                étudier dès que le bénéfice dépasse 30 k€ par an.
              </p>
              <p>
                <strong>Hors champ</strong> : présidents et DG de SAS ou SASU (assimilés salariés —
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border p-2">32–55 € par mois</td>
                  ...
                  <tr>
                    ...
                    <td className="border p-2">38–62 € par mois</td>
                  ...
                  <tr>
                    ...
                    <td className="border p-2">42–70 € par mois</td>
                    <td className="border p-2">Garanties optique ou dentaire premium</td>
                  ...
                  <tr>
                    ...
                    <td className="border p-2">52–95 € par mois</td>
                  ...
                  <tr>
                    ...
                    <td className="border p-2">36–58 € par mois</td>
                  ...
                  <tr>
                    ...
                    <td className="border p-2">35–60 € par mois</td>
            ...
            <>
              <ol>
                <li>
                  ...
                  critique. Privilégier 60% santé ou 40% prévoyance dans le plafond Madelin.
                </li>
                <li>
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Plafond annuel = 3,75% du PASS (1 766€ en 2026) + 7% de votre bénéfice imposable. Pour un bénéfice de 60 k€, cela fait environ 5 826€ par an déductibles, partagés entre santé et prévoyance Madelin. Économie d'impôt nette ≈ 1 750€ par an pour un TNS au TMI 30%.",
        },
        {
          q: 'Auto-entrepreneur, puis-je avoir une mutuelle Madelin ?',
          a: "Pas en régime micro-fiscal classique (versement libératoire) — les cotisations Madelin ne sont alors PAS déductibles. Pour bénéficier de Madelin, il faut basculer au régime réel d'imposition (option à activer auprès du SIE). Démarche pertinente dès que votre bénéfice dépasse ~30 k€ par an car l'économie fiscale Madelin couvre alors largement le coût additionnel comptable.",
        },
        {
          q: 'Mutuelle TNS ou contrat collectif salarié ? Si je suis dirigeant assimilé salarié.',
          a: "Si vous êtes président ou DG de SAS ou SASU, vous êtes assimilé salarié — donc le contrat collectif d'entreprise (avec prise en charge employeur ≥ 50%) est généralement plus avantageux fiscalement et économiquement qu'un contrat TNS individuel Madelin. Pour les gérants majoritaires de SARL ou EI : le TNS Madelin reste la voie standard.",
        },
        {
          q: 'Puis-je résilier ma mutuelle TNS à tout moment ?',
          a: "Depuis la loi du 14 juillet 2019, oui : résiliation infra-annuelle possible après 1 an d'engagement, sans frais, sans motif, par lettre recommandée / notification dans l'espace adhérent. Le nouvel assureur peut faire la démarche pour vous (mandat). Effet : 1er du mois suivant la réception de la résiliation par l'ancien assureur.",
        },
        {
          q: "Mes cotisations Madelin santé augmentent-elles avec l'âge ?",
          a: "Oui, généralement : ~+1 à +2 % par an chez la plupart des assureurs. Cette progression suit l'évolution moyenne des dépenses de santé par tranche d'âge (statistiques ACPR). Pour limiter cet effet, privilégier les contrats à « tarif lissé » ou les mutualistes (qui mutualisent davantage le risque entre les âges).",
        },
        {
