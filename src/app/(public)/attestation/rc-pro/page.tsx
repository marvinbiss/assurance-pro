...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Attestation RC Pro : obtenir en 24h. Modèle PDF, mentions obligatoires. Hiscox ou Stello immédiat, April Pro 24h, autres 24-48h. Tous statuts juridiques.',
...
export default function Page() {
  return (
    <PilierLayout
      ...
      title={TITLE}
      tagline={TAGLINE}
      intro="Comment obtenir votre attestation RC Pro rapidement : 3 chemins selon votre situation. 1) Pas encore d'assurance ? Devis comparatif gratuit + souscription = attestation immédiate (Hiscox ou Stello). 2) Déjà assuré ? Connexion espace adhérent + téléchargement direct (24h max). 3) Urgence client ? Attestation provisoire émise sous 4h par certains assureurs."
      ...
      benefits={[
        {
          icon: '⚡',
          title: 'Délai 24h max',
          desc: 'Hiscox ou Stello immédiat • April Pro 24h • Allianz ou MMA 48h',
        },
        {
          icon: '📄',
      ...
      sections={[
            ...
            <ol>
              <li>
                ...
                <ul>
                  ...
                  <li>Attestation téléchargeable immédiatement (Hiscox ou Stello)</li>
                </ul>
              </li>
              <li>
              ...
              <li>
                <strong>Chemin 3 — Urgence chantier ou contrat</strong> :
                <ul>
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>SIRET valide</li>
              <li>K-bis (SARL ou SAS) ou ACOSS (AE)</li>
              <li>CNI — passeport</li>
        ...
        },
        {
          ...
          body: (
            <ul>
              ...
              <li>
                <strong>Identité assuré</strong> : nom ou raison sociale + SIRET cohérents
              </li>
            </ul>
          ),
        },
      ...
      faq={[
        {
          ...
          a: 'Immédiat (téléchargement) si déjà assuré chez Hiscox, Stello, Allianz ou MMA avec espace adhérent. 5 minutes total si pas encore assuré et choix Hiscox ou Stello (souscription + attestation). 4h pour attestation provisoire urgence chez April Pro ou Hiscox.',
        },
        {
        ...
        },
        {
          ...
          a: 'OUI 24/7 chez Hiscox, Stello ou Allianz Pro ou MMA (espace adhérent accessible). NON chez April Pro ou AXA Pro (système indisponible la nuit). Stocker copie PDF sur cloud personnel pour accès illimité.',
        },
        {
          q: "L'attestation suffit-elle comme preuve d'assurance ?",
          a: 'OUI pour usage commercial standard (clients B2B, Ordres, administration). NON pour contentieux / expertise sinistre : le contrat complet (CG + CP + IPID) est le document juridique de référence. Toujours conserver les 3 documents.',
        },
      ]}
      relatedMetiers={[
        {
