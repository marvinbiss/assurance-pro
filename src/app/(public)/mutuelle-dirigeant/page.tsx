...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    "Mutuelle dirigeant SASU ou SAS : régime collectif d'entreprise pour président assimilé salarié. Garanties haut de gamme cadres (optique premium, dentaire renforcé, médecines douces). Déductible 100% du résultat. Tarifs 80-220€ par mois. Devis ORIAS sous 24h.",
...
export default function Page() {
  return (
    <PilierLayout
      ...
      title={TITLE}
      tagline={TAGLINE}
      intro="La mutuelle dirigeant désigne la complémentaire santé adaptée aux dirigeants ASSIMILÉS SALARIÉS (président SASU ou SAS, gérant minoritaire SARL). Particularité : ils relèvent du régime général de la Sécurité Sociale (vs régime TNS pour gérant majoritaire SARL, EURL ou EI). Conséquence : ÉLIGIBILITÉ aux contrats collectifs d'entreprise (mutuelle ANI 2013, déductible 100% du résultat de la société) MAIS NON ÉLIGIBILITÉ à la Loi Madelin (réservée aux TNS). Avantages : garanties souvent supérieures aux contrats individuels (optique premium, dentaire renforcé, médecines douces, hospitalisation 400% BR), déduction 100% du résultat (pas plafond Madelin), tarifs négociés grâce à la mutualisation collective. Tarifs 2026 : 80-220€ par mois selon profil et garanties choisies."
      ...
      benefits={[
        ...
        },
        {
          ...
          desc: 'Du résultat de la société (vs plafond Madelin pour TNS ~5 800€ par an)',
        },
        {
          icon: '🩺',
        ...
        {
          icon: '⚡',
          title: 'À partir de 80 € par mois',
          desc: 'Dirigeant 35 ans formule confort. Premium famille : 180-220€ par mois',
        },
      ]}
      sections={[
        {
      ...
      faq={[
        {
          ...
          a: 'DÉPEND DU STATUT : SASU ou SAS président + gérant minoritaire SARL = ASSIMILÉ SALARIÉ → régime COLLECTIF (Madelin NON applicable, mais déduction 100% du résultat). SARL gérant majoritaire — EI — EURL = TNS → Madelin individuel (déductible BNC plafond ~5 800€ par an).',
        },
        {
          q: 'Combien coûte une mutuelle dirigeant en 2026 ?',
          a: '80-120€ par mois pour dirigeant 35 ans solo (formule confort). 160-240€ par mois pour dirigeant + conjoint. 220-320€ par mois pour famille 4 personnes. 280-420€ par mois pour cadre dirigeant haut de gamme Paris.',
        },
        {
          q: 'Mutuelle dirigeant SASU 1 personne : possible ?',
          a: 'OUI possible et avantageux. Le président SASU peut souscrire un contrat collectif « 1 personne » comme employeur de lui-même. Coût optimisé + déductible 100% du résultat (vs Madelin 5 800€ par an plafond pour TNS).',
        },
      ]}
    />
  )
