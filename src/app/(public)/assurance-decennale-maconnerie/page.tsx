...
const TAGLINE =
  'Le maçon (traditionnel, béton armé, pierre sèche) est soumis à la décennale. Tarif AE 1 800-2 800€ par an, SARL 2 500-5 000€ par an. 12% sinistralité (AQC).'

export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'Décennale maçonnerie : 3 spécialisations (traditionnel, béton armé, pierre sèche). AE 1 800-2 800€ par an, SARL 2 500-5 000€ par an. April Pro, SMABTP, Allianz.',
      ...
      sections={[
          ...
          body: (
            <ul>
              <li>
                ...
                DTU 20.1. Tarif AE : 1 800-2 500€ par an.
              </li>
              <li>
                <strong>Maçon béton armé</strong> : coffrage métallique ou bois + ferraillage +
                coulage. Norme DTU 21. Plus technique. Tarif AE : 2 200-2 800€ par an.
              </li>
              <li>
                <strong>Maçon pierre sèche</strong> : spécialiste restauration patrimoine, murs de
                soutènement traditionnels. Tarif AE : 2 000-2 500€ par an (peu de chantiers, risque
                modéré).
              </li>
              <li>
                <strong>Maçon-coffreur béton armé spécialisé</strong> : combine les 3. Tarif AE : 2
                500-3 500€ par an. Qualifications Qualibat 2151+.
              </li>
            </ul>
          ),
        },
        ...
        },
        {
          ...
          body: (
            <ul>
              <li>
                <strong>Maçon traditionnel AE (CA &lt; 80k€)</strong> : 1 800-2 200€ par an, plafond
                1-2M€
              </li>
              <li>
                <strong>Maçon béton armé AE</strong> : 2 200-2 800€ par an
              </li>
              <li>
                <strong>Maçon pierre sèche AE</strong> : 2 000-2 500€ par an (niche restauration)
              </li>
              <li>
                <strong>Maçon-coffreur spécialisé AE</strong> : 2 500-3 500€ par an
              </li>
              <li>
                <strong>SARL maçonnerie (1-5 salariés)</strong> : 2 500-4 500€ par an, plafond 2-3M€
              </li>
              <li>
                <strong>SARL gros-œuvre complet (5-15 salariés)</strong> : 3 500-7 000€ par an
              </li>
              <li>
                <strong>SAS BTP gros-œuvre PME</strong> : 5 500-12 000€ par an, plafond 3-5M€
              </li>
            </ul>
          ),
        },
      ...
      faq={[
        {
          ...
          a: 'AE maçon traditionnel (CA &lt; 80k€) : 1 800-2 200€ par an chez April Pro ou Allianz Pro. AE maçon béton armé : 2 200-2 800€ par an. Plafond 1-2M€. Notre courtier ORIAS compare April Pro, SMABTP, Allianz Pro, MMA Pro BTP, AXA Pro BTP.',
        },
        {
          q: 'Qualifications maçonnerie recommandées pour réduire prime ?',
          a: 'Qualibat 2111 (maçon traditionnel) ou 2151 (béton armé spécialisé) = -5-10% sur prime décennale. CAP, BEP ou BP Maçonnerie : reconnaissance compétences. RGE Qualibat pour isolation thermique (ITE ou ITI).',
        },
        {
        ...
        },
        {
          ...
          a: 'Pack recommandé : Décennale (3 500-5 500€ par an) + RC Pro BTP (600-900€ par an) + Multirisque BTP local (1 200-2 500€ par an) + Flotte 3 véhicules (3 000-5 000€ par an) = 8 300-13 900€ par an total. Remise paquet -15-25% chez April Pro — MMA BTP.',
        },
      ]}
      relatedMetiers={[
