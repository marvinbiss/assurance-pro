...
export const metadata: Metadata = {
  ...
  description: 'Processus de médiation de Assurance Pro : réclamation, médiation interne et externe, délais de traitement. Résolution amiable des litiges.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Assurance Pro — Médiation' }],
  },
  twitter: {
