...
const faqTitle = 'FAQ — Questions Artisans et Travaux | Assurance Pro'

export const metadata: Metadata = {
  title: faqTitle,
  description: 'Retrouvez les réponses aux questions les plus fréquentes sur Assurance Pro : inscription, devis, fonctionnement de l\'annuaire d\'artisans.',
  alternates: {
    canonical: `${SITE_URL}/faq`,
  },
  openGraph: {
    title: faqTitle,
    description: 'Retrouvez les réponses aux questions fréquentes sur Assurance Pro.',
    url: `${SITE_URL}/faq`,
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Assurance Pro — FAQ' }],
  },
  twitter: {
