  ...
  return (
    <PilierLayout
      ...
      benefits={[
        {
          icon: '👨‍💼',
          title: 'Capital ou rente entreprise',
          desc: "L'entreprise est bénéficiaire (pas la famille). Indemnise la perte de revenus liée à la disparition",
        },
        {
          icon: '💼',
          title: 'Charges déductibles',
          desc: 'Cotisations déductibles du résultat imposable (art. 39 CGI). Fiscalité optimisée',
        },
        {
          icon: '🏦',
        ...
        },
        {
          ...
          desc: "Devis sous 24h, formalités médicales allégées jusqu'à 200 k€ de capital assuré",
        },
      ]}
      sections={[
        {
          ...
          body: (
            <>
              <p>
                Un homme-clé (ou femme-clé — terme générique « personne-clé ») est défini par la
                jurisprudence et la pratique assurantielle comme une personne dont la disparition ou
                l&apos;incapacité de travail entraînerait une perte significative pour
                l&apos;entreprise, généralement caractérisée par :
              </p>
              <ul>
                <li>
                  Une <strong>contribution déterminante au chiffre d&apos;affaires</strong> (apport
                  commercial direct &gt; 30%)
                </li>
                <li>
                  Un <strong>savoir-faire technique unique</strong> non transférable rapidement
                  (brevet, méthode propriétaire, expertise rare)
                </li>
                <li>
                  Un <strong>réseau professionnel critique</strong> (clés clients institutionnels,
                  partenariats stratégiques)
                </li>
                <li>
                  Un <strong>rôle de pilotage opérationnel</strong> sans backup interne (CEO solo,
                  CTO unique)
                </li>
                <li>
                  Un <strong>statut juridique spécifique</strong> (gérant unique de SARL, associé
                  unique d&apos;EURL, médecin associé d&apos;une SELARL)
                </li>
              </ul>
              <p>
        ...
        },
        {
          ...
          body: (
            <>
              <p>
                Tarifs indicatifs 2026 pour un capital décès + invalidité absolue, basés sur les
                barèmes de nos 5 partenaires (AXA Pro, Allianz Vie, Generali, Hiscox, Aviva Pro) :
              </p>
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border p-2">Dirigeant 35 ans, non-fumeur, sans antécédent</td>
                    <td className="border p-2 text-right">200 000 €</td>
                    <td className="border p-2 text-right">280 € – 420 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Dirigeant 45 ans, non-fumeur</td>
                    <td className="border p-2 text-right">500 000 €</td>
                    <td className="border p-2 text-right">980 € – 1 580 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">CTO 38 ans, fumeur</td>
                    <td className="border p-2 text-right">300 000 €</td>
                    <td className="border p-2 text-right">680 € – 1 100 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Médecin associé SELARL, 50 ans</td>
                    <td className="border p-2 text-right">400 000 €</td>
                    <td className="border p-2 text-right">1 280 € – 2 100 €</td>
                  </tr>
                  <tr>
                    <td className="border p-2">Sportif pro, 28 ans</td>
                    <td className="border p-2 text-right">1 000 000 €</td>
                    <td className="border p-2 text-right">2 800 € – 6 200 €</td>
                  </tr>
                </tbody>
              </table>
        ...
        },
        {
          ...
          body: (
            <>
              <p>L&apos;assurance homme-clé bénéficie d&apos;un régime fiscal favorable :</p>
              <ul>
                <li>
                  <strong>Cotisations déductibles</strong> du résultat imposable au titre de
                  l&apos;article 39 du CGI (charges générales d&apos;exploitation), sous conditions
                  cumulatives :
                  <ul>
                    <li>L&apos;entreprise est seule bénéficiaire du capital (pas la famille)</li>
                    <li>
                      L&apos;assurance correspond à un intérêt économique réel (lien de causalité
                      personne-CA)
                    </li>
                ...
                <li>
                  <strong>Capital perçu imposable</strong> au résultat (IS ou IR selon la forme
                  juridique), mais étalable sur 5 ans pour absorber l&apos;impact
                </li>
                <li>
                  <strong>Pas de contributions sociales</strong> URSSAF sur les cotisations (vs
                  assurance prévoyance individuelle)
                </li>
              </ul>
              <p>
                <strong>Cas particulier des cabinets libéraux (BNC)</strong> : les cotisations sont
                déductibles directement sur le bénéfice non commercial, sans plafond Madelin
          ...
          body: (
            <>
              ...
              <ol>
                ...
                <li>
                  <strong>Méthode du multiple de marge brute apportée</strong> : capital = 2 ans de
                  marge brute imputable à la personne. Utile pour un commercial qui apporte 70 % du
                  CA mais n&apos;est pas le mieux payé.
                </li>
                <li>
                  <strong>Méthode du coût de remplacement</strong> : capital = (recrutement
                  remplaçant + formation 12 mois + perte de productivité pendant la transition +
                  impact commercial sur 24 mois). Pour un CTO start-up : facilement 800 k€ – 1,5 M€.
                </li>
              </ol>
              <p>
                Recommandation pragmatique : prendre le maximum des 3 méthodes, plafonner à 5× la
                rémunération brute annuelle (au-delà, l&apos;administration fiscale peut requalifier
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Oui, déductibles du résultat imposable au titre de l'article 39 du CGI (charges d'exploitation), sous 3 conditions : entreprise seule bénéficiaire, intérêt économique réel démontrable, contrat sans capitalisation. Capital perçu en cas de sinistre : imposable au résultat, étalable sur 5 ans.",
        },
        {
          q: 'Différence entre assurance homme-clé et assurance prévoyance individuelle du dirigeant ?',
          a: 'Assurance homme-clé = ENTREPRISE bénéficiaire (compense la perte économique). Assurance prévoyance individuelle = FAMILLE bénéficiaire (capital décès, rente conjoint, rente éducation). Les deux sont complémentaires : un dirigeant patrimonial bien équipé a généralement les deux.',
        },
        {
        ...
        },
        {
          ...
          a: "Le contrat homme-clé peut être : (1) résilié immédiatement par l'entreprise (loi Hamon), (2) transformé en contrat individuel à votre nom avec maintien des garanties (rachat possible), (3) maintenu par l'entreprise jusqu'à votre départ effectif si transition longue. À étudier au cas par cas avec votre courtier.",
        },
        {
          q: 'Combien de temps pour obtenir un devis homme-clé ?',
          a: "Devis personnalisé via notre formulaire : 24h ouvrées avec 3 propositions. Souscription : 48h pour capital ≤ 200 k€ (questionnaire de santé simple). Au-delà : 7-15 jours (examen médical complémentaire requis : analyses de sang, ECG, parfois épreuve d'effort).",
        },
      ]}
    />
  )
