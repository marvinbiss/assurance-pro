...
export const metadata: Metadata = {
  title: `${TITLE}`,
  description:
    'MAIF RC Pro : assureur mutualiste, fort sur associations + ESS + professions libérales (enseignants, médical). Tarif 180-1 500€ par an. Comparatif honnête avec MMA et Hiscox.',
    ...
    <PilierLayout
          ...
          body: (
            <ul>
              <li>
                ...
                180€ par an, couverture activités événementielles, encadrants bénévoles, dommages
                matériels club.
              </li>
              <li>
                <strong>
          ...
          body: (
            <ul>
              <li>
                ...
                consultant business, agence digitale — Hiscox ou Stello ou Allianz Pro sont moins
                chers de 15-30%.
              </li>
              <li>
          ...
          body: (
            <ul>
              <li>
                ...
                culture. Pas optimal pour services commerciaux purs ou BTP.
              </li>
              <li>
              ...
              <li>
                <strong>MMA Pro</strong> : équilibré tous secteurs, fort sur SARL ou SAS PME,
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'RC Pro Asso 1901 starter : 180-300€ par an (asso &lt; 20 adhérents, peu d&apos;activités), 300-600€ par an (asso 50-200 adhérents, activités hebdo régulières), 600-1 500€ par an (grande asso ou ESS structure).',
        },
        {
          q: 'MAIF Pro vs Hiscox : lequel pour un consultant ?',
          a: 'Pour un consultant freelance commercial (services aux entreprises) avec CA &lt; 80k€ : Hiscox sera 30-50% moins cher (95-180€ par an vs 250-400€ chez MAIF). Pour un consultant social, formation ou coaching éthique, la MAIF reste pertinente.',
        },
        {
          q: 'Comment souscrire MAIF RC Pro ?',
          a: 'Via maif.fr → onglet &quot;Pro et Asso&quot;. Devis en ligne possible, souscription souvent finalisée par un conseiller MAIF (téléphone / agence). Délai 24-48h pour attestation.',
        },
      ]}
      relatedMetiers={[
