/**
 * Pilier — Assurance décennale pas cher 2026
 *
 * KW Ahrefs validés via kw_universe Supabase (Tier 3) :
 * - 600 vol KD 26 : assurance décennale pas cher
 * - 60 vol KD null : assurance décennale auto entrepreneur moins cher
 * - 50 vol KD 24 : assurance décennale moins cher
 * Volume cumul : 750 • ROI cumul : 294 000 score
 */
...
const TITLE = "Assurance décennale pas cher 2026"
...
const INTRO = "Cette page est dédiée à assurance décennale pas cher 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil. Estimation indicative basée sur 4 KW Ahrefs analysés (volume cumulé 750 recherches/mois). Devis officiel personnalisé sous 24h ouvrées."
...
export const metadata: Metadata = {
  ...
  description: "Cette page est dédiée à assurance décennale pas cher 2026. Notre cabinet ORIAS analyse pour vous les obligations légales, les tarifs 2026 négociés auprès de nos 8 assureurs partenaires, les sinistres types couverts, et les leviers d'optimisation tarifaire spécifiques à ce profil.",
  ...
  return (
    <PilierLayout
      ...
      benefits={[
        ...
        { icon: '📊', title: 'Data Ahrefs validée', desc: "4 KW analysés • 750 vol/m cumul" },
      ...
      sections={[
        {
          ...
          body: (
            <div>
              <p className="text-sm">Cette page cible 4 mots-clés validés dans notre base Ahrefs (volume mensuel cumulé : 750). Les requêtes principales :</p>
              <ul className="mt-2 space-y-1 text-sm">
              <li>600 vol KD 26 : assurance décennale pas cher</li>
              <li>60 vol KD null : assurance décennale auto entrepreneur moins cher</li>
              <li>50 vol KD 24 : assurance décennale moins cher</li>
              </ul>
            </div>
          ),
        },
      ...
      faq={[
        ...
        { q: 'Tarifs 2026 indicatifs ?', a: "Variables selon profil : statut juridique, CA, antécédents, plafond garantie. Notre cabinet compare 8 assureurs partenaires pour optimiser tarif vs couverture. 4 KW analysés Ahrefs montrent un volume marché de 750 recherches/mois sur ce sujet — preuve de demande commerciale réelle." },
