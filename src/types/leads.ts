...
export const URGENCY_META: Record<string, { label: string; cls: string }> = {
  ...
  semaine: { label: 'Cette semaine', cls: 'bg-yellow-100 text-yellow-700' },
  mois: { label: 'Ce mois-ci', cls: 'bg-blue-100 text-blue-700' },
  flexible: { label: 'Pas urgent', cls: 'bg-green-100 text-green-700' },
}
