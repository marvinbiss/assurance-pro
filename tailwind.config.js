...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary - Midnight Navy (corporate assurance pro standard — trust YMYL)
        primary: {
          50:  '#EEF2F8',
          100: '#D7DFEC',
          200: '#AFBFD9',
        ...
        // Secondary - Antique Gold (highlights, awards, premium accent — luxury)
        secondary: {
          50:  '#FBF7EC',
          100: '#F5EDD0',
          200: '#EBD99B',
      ...
      fontFamily: {
        ...
        'display-premium': ['var(--font-heading)', 'Playfair Display', 'Georgia', 'serif'],
      ...
      boxShadow: {
        'glow': '0 0 20px rgba(43, 77, 133, 0.30)',
        'glow-lg': '0 0 40px rgba(43, 77, 133, 0.38)',
        'glow-amber': '0 0 30px rgba(184, 151, 90, 0.18)',
        'glow-gold': '0 0 30px rgba(201, 169, 97, 0.45)',
        'glow-terra': '0 0 30px rgba(43, 77, 133, 0.22)',
